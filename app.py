...
సూక్ష్మ శిలాయుగంలో మానవుడు వాడిన రాతి పరికరాలు 1 సెం.మీ నుండి 8 సెం.మీ మధ్య ఉండేవి — వీటినే Microliths అంటారు. ఇటువంటి సూక్ష్మ శిలలను C. Weld అనే అర్కియాలజిస్ట్ వింధ్యపర్వత ప్రాంతాలలో కనుగొన్నారు.
...
Mini Recap: దక్షిణ — 2000 BC నుండి. బూడిద దిబ్బలు ముఖ్య లక్షణం. బ్రహ్మగిరి — మోర్టిమర్ వీలర్. తేక్కల్‌కోట్ — బంగారు ఆభరణాలు. మొత్తం 15 ముఖ్య స్థావరాలు."""
        },
        {
            ...
            "sub": "Metal Age · Chalcolithic · Copper · Late Harappan Cultures · Jhukar · Jhangar",
...
భారత ఉపఖండంలో తాంబ్రశిలాయుగంలో వర్ధిల్లిన మహోన్నత నాగరికత సింధు లేదా హరప్పా నాగరికత. హరప్పా నాగరికత క్షీణతకు గురైనా సమకాలంగా కొన్ని తాంబ్ర శిలాయుగ సంస్కృతులు వర్ధిల్లటం గమనార్హం. ఆవిధంగా హరప్పా నాగరికతలో అభివృద్ధి చెందిన దశ తరువాత సంస్కృతులకే గల పేరు హారప్పానంతర సంస్కృతులు (Late Harappan Culture).

పురావస్తు శాస్త్రవేత్త ప్రకారం హారప్పానంతర సంస్కృతులు క్రీ.పూ. 2000 నుండి క్రీ.పూ. 500 వరకు వర్ధిల్లినవి.

మొదటి రెండు ముఖ్యమైన హారప్పానంతర సంస్కృతులు:

జుకర్ సంస్కృతి (Jhukar Culture):
జుకర్ సంస్కృతికి సంబంధించిన ప్రముఖ స్థావరాలు చాన్హుదారో, జుకర్ మరియు అమి. ఇది పశ్చిమాసియాలోని సంస్కృతులతో అనేక సామీప్యతలు కల్గి ఉంది. జుకర్‌సంస్కృతిలో లక్షణాలు: గోధుమ లేదా మూడురు గోధుమ వర్ణం గల పాత్రలు. గోధుమ వర్ణపు పాత్రపై ఎర్రని గీతలు ఉండినవి. గోధుమ వర్ణపు పాత్ర మీద ఆకృతులు చిత్రించిన Ochre-Coloured Pottery (OCP). ఈ సంస్కృతిలో వినియోగపడిన పరికరాలు: రాగితో తయారు చేయబడిన సూచులు (Copper Needles), కంచు గొడ్డళ్ళు (Bronze Axes), ముద్రికలు మరియు ఫేయాన్స్ (Seals-Pheyans).

ఝంగర్ సంస్కృతి (Jhangar Culture):
సింధ ప్రాంతంలోని ఝంగర్‌లో బయల్పడిన హారప్పానంతర సంస్కృతియే ఝంగర్ సంస్కృతి. ఈ సంస్కృతి ఆనవాళ్ళు కూడా లభించిన స్థావరంగా చాన్హుదారో గుర్తించబడింది. ఈ సంస్కృతిలో వినియోగించిన పాత్రలు గచ్చకాయ రంగువి. ప్రముఖ హారప్పానంతర సంస్కృతి స్థావరము దైమాబాద్ (మహారాష్ట్ర).

Mini Recap: రాగి = తొలి లోహం. Chalcolithic = తాంబ్రశిలాయుగ. జుకర్ — OCP పాత్రలు + Copper Needles. ఝంగర్ — గచ్చకాయ రంగు పాత్రలు."""
        },
        {
