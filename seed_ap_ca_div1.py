...
MCQ_DATA = [
    ...
    (0, 2,
     "అత్యధిక పోలింగ్ నమోదైన నియోజకవర్గం ఏ జిల్లాలో ఉంది?",
     "ప్రకాశం", "అనంతపురం", "కర్నూల్", "చిత్తూరు",
     "a",
     "దార్సి నియోజకవర్గం ప్రకాశం జిల్లాలో ఉంది, అక్కడ 90.91% పోలింగ్ నమోదైంది."),
