...
SECTIONS_JSON = [
    ...
    },
    {
        ...
        "audio": "ఆంధ్రప్రదేశ్ నుండి మొత్తం 25 లోక్‌సభ స్థానాలు ఉన్నాయి. TDP 17 స్థానాల్లో పోటీ చేసి 16 గెలిచింది. JSP 2 స్థానాల్లో 2 గెలిచింది. BJP 6 స్థానాల్లో 3 గెలిచింది. కూటమి మొత్తం 21 లోక్‌సభ స్థానాలు గెలిచింది. YSRCP 25 స్థానాల్లో 4 మాత్రమే గెలిచింది. పవన్ కళ్యాణ్ పిఠాపురం నుండి లోక్‌సభ ఎన్నికలో కూడా గెలిచారు."
    },
    {
    ...
    },
    {
        ...
        "audio": "నారా లోకేష్ HRD (విద్య), IT ఎలక్ట్రానిక్స్, RTG. వంగలపూడి అనిత Home Affairs, Disaster Management. పయ్యావుల కేశవ్ Finance, Planning, Commercial Taxes. సత్యకుమార్ యాదవ్ (BJP, ధర్మవరం) Health, Medical Education — BJP నుండి ఏకైక మంత్రి. నాస్యం మొహమ్మద్ ఫారూఖ్ (ఏలూరు) Law & Justice, Minority Welfare — ఏకైక ముస్లిం మంత్రి. కొలుసు పార్థసారథి Housing, I&PR. గొట్టిపాటి రవికుమార్ Energy. మండిపల్లి రాంప్రసాద్ రెడ్డి Transport, Youth & Sports. అనగాని సత్యప్రసాద్ Revenue, Stamps & Registration."
    },
    {
        "title": "JSP మంత్రులు & ఇతర మంత్రులు",
        "sub": "JSP Ministers & Other Key Ministers",
        "audio": "JSP నుండి 3 మంత్రులు: పవన్ కళ్యాణ్ (DCM), నాదెండ్ల మనోహర్ (Civil Supplies, Consumer Affairs), కందుల దుర్గేష్ (Social Welfare, Tribal Welfare). ఇతర TDP మంత్రులు: P. నారాయణ — MAUD. నిమ్మల రమానాయుడు — Roads & Buildings. BC జనార్దన్ రెడ్డి — Water Resources. కొండపల్లి శ్రీనివాస్ — MSME, SERP, NRI Affairs."
    },
    {
...
MCQ_DATA = [
    ...
    (2, 2,
     "2024 లోక్‌సభ ఎన్నికల్లో పవన్ కళ్యాణ్ ఏ నియోజకవర్గం నుండి గెలిచారు?",
     "అనకాపల్లి", "పిఠాపురం", "రాజమండ్రి", "కాకినాడ",
     "b",
     "పవన్ కళ్యాణ్ పిఠాపురం నియోజకవర్గం నుండి లోక్‌సభ ఎన్నికలో కూడా గెలిచారు."),
    ...
    (5, 1,
     ...
     "c",
     "పయ్యావుల కేశవ్ (TDP, రాజం) AP ఆర్థిక మంత్రి. ఆయన ఫిబ్రవరి 28, 2025న బడ్జెట్ సమర్పించారు."),
    ...
    (5, 2,
     ...
     "b",
     "నాస్యం మొహమ్మద్ ఫారూఖ్ (TDP, ఏలూరు) Law & Justice, Minority Welfare మంత్రి — ఏకైక ముస్లిం మంత్రి."),
    ...
    (5, 2,
     ...
     "c",
     "గొట్టిపాటి రవికుమార్ (TDP, మచిలీపట్నం) Energy (విద్యుత్) పోర్ట్‌ఫోలియో నిర్వహిస్తారు."),
    ...
    (5, 3,
     ...
     "b",
     "మండిపల్లి రాంప్రసాద్ రెడ్డి (TDP, ఆత్మకూరు) Transport, Youth & Sports పోర్ట్‌ఫోలియో నిర్వహిస్తారు."),
    ...
    (6, 2,
     "AP Social Welfare & Tribal Welfare మంత్రి ఎవరు?",
     "నాదెండ్ల మనోహర్", "కందుల దుర్గేష్", "సత్యకుమార్ యాదవ్", "అచ్చెన్నాయుడు",
     "b",
     "కందుల దుర్గేష్ (JSP) Social Welfare & Tribal Welfare పోర్ట్‌ఫోలియో. JSP నుండి మూడో మంత్రి."),
    ...
    (6, 3,
     ...
     "b",
     "కొండపల్లి శ్రీనివాస్ (TDP, విజయవాడ పశ్చిమ) MSME, SERP, NRI Affairs పోర్ట్‌ఫోలియో."),
    ...
    (7, 3,
     ...
     "నెల్లూరు", "రాజం", "కుప్పం", "ధర్మవరం",
     "b",
     "పయ్యావుల కేశవ్ రాజం నియోజకవర్గం (శ్రీకాకుళం జిల్లా) నుండి ఎన్నికయ్యారు."),
]
