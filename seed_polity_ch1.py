# -*- coding: utf-8 -*-
# Indian Polity — Chapter 1: Historical Background (చారిత్రక నేపథ్యం)
# Source: M. Lakshmikanth — Indian Polity (Latest Edition)
# Subject: GK | Topic: Indian_Polity | Chapter: 1
# MCQ Divisions: Easy(1) · Moderate(2) · Tough(3) · Toughest(4) · PYQ(exam_type='APPSC'/'UPSC')
# Total Sections: 12 | Total MCQs: 88
...
POLITY_CH1_SECTIONS = [
    {
        "title": "1.1 బ్రిటిష్ పాలన ప్రారంభం — కంపెనీ నుండి క్రౌన్ వరకు",
        "sub": "Company Rule · Charter Acts · Crown Rule · 1858 Act",
        "audio": """భారత రాజ్యాంగానికి (Constitution) చారిత్రక నేపథ్యం అర్థం చేసుకోవాలంటే, బ్రిటిష్ వారు భారతదేశాన్ని ఎలా పాలించారో తెలుసుకోవాలి.

బ్రిటిష్ వారు రెండు దశల్లో భారతదేశాన్ని పాలించారు:
1. కంపెనీ పాలన (Company Rule) — 1773 నుండి 1858 వరకు
2. క్రౌన్ పాలన (Crown Rule) — 1858 నుండి 1947 వరకు

📌 కంపెనీ పాలన (1773–1858):
ఈస్ట్ ఇండియా కంపెనీ (East India Company) వ్యాపారం చేయడానికి వచ్చింది, కానీ క్రమంగా రాజకీయ అధికారం సంపాదించింది. కంపెనీ పాలనను నియంత్రించడానికి బ్రిటిష్ పార్లమెంట్ (British Parliament) అనేక చట్టాలు చేసింది — వాటినే Charter Acts అంటారు.

📌 క్రౌన్ పాలన (1858–1947):
1857 సిపాయిల తిరుగుబాటు (Sepoy Mutiny / First War of Independence) తర్వాత, 1858లో "భారత ప్రభుత్వ చట్టం (Government of India Act 1858)" ద్వారా కంపెనీ పాలన రద్దు చేయబడింది. అప్పటి నుండి భారత పాలన నేరుగా బ్రిటిష్ క్రౌన్ (British Crown) చేతికి వెళ్ళింది.

పరీక్షలో గుర్తుపెట్టుకోండి:
• కంపెనీ పాలన: 1773–1858 (85 సంవత్సరాలు)
• క్రౌన్ పాలన: 1858–1947 (89 సంవత్సరాలు)
• 1857 తర్వాత మార్పు వచ్చింది — ఇది APPSC లో తరచుగా అడుగుతారు!"""
    },
    {
        "title": "1.2 రెగ్యులేటింగ్ యాక్ట్ 1773 మరియు పిట్స్ ఇండియా యాక్ట్ 1784",
        "sub": "Regulating Act 1773 · Pitt's India Act 1784 · Board of Control · Governor General",
        "audio": """భారత రాజ్యాంగ చరిత్రలో మొట్టమొదటి ముఖ్యమైన చట్టం — రెగ్యులేటింగ్ యాక్ట్ 1773 (Regulating Act 1773).

📌 రెగ్యులేటింగ్ యాక్ట్ 1773 — ముఖ్యమైన అంశాలు:
• బ్రిటిష్ పార్లమెంట్ కంపెనీ వ్యవహారాలను నియంత్రించడానికి చేసిన మొట్టమొదటి చట్టం
• బెంగాల్ గవర్నర్‌ను "గవర్నర్ జనరల్ ఆఫ్ బెంగాల్ (Governor General of Bengal)" గా పేరు మార్చారు
• మొదటి గవర్నర్ జనరల్: వారెన్ హేస్టింగ్స్ (Warren Hastings)
• కలకత్తాలో సుప్రీం కోర్ట్ (Supreme Court) ఏర్పాటు చేశారు (1774లో)
• కంపెనీ డైరెక్టర్ల కోర్ట్ (Court of Directors) బ్రిటిష్ ప్రభుత్వానికి నివేదించాలి

📌 పిట్స్ ఇండియా యాక్ట్ 1784 (Pitt's India Act 1784):
• కంపెనీ వ్యవహారాలపై ద్వంద్వ పాలన (Double Government) ప్రవేశపెట్టింది
• Board of Control (రాజకీయ వ్యవహారాలు) + Court of Directors (వ్యాపార వ్యవహారాలు)
• భారతదేశంలో బ్రిటిష్ ఆక్రమణ ప్రాంతాలను "British Possessions in India" అని పేర్కొన్నారు

రాసుకోండి:
• రెగ్యులేటింగ్ యాక్ట్ 1773 = మొదటి నియంత్రణ చట్టం = Warren Hastings మొదటి G.G.
• పిట్స్ ఇండియా యాక్ట్ 1784 = ద్వంద్వ పాలన = Board of Control ఏర్పాటు"""
    },
    {
        "title": "1.3 చార్టర్ యాక్ట్స్ — 1813, 1833, 1853",
        "sub": "Charter Acts · Trade Monopoly · Governor General of India · Legislative Council",
        "audio": """చార్టర్ యాక్ట్స్ (Charter Acts) అంటే ఈస్ట్ ఇండియా కంపెనీకి బ్రిటిష్ పార్లమెంట్ ఇచ్చిన అనుమతి పత్రాలు (Charters). ప్రతి 20 సంవత్సరాలకు పునర్విమర్శ జరిగేది.

📌 చార్టర్ యాక్ట్ 1813:
• కంపెనీ వ్యాపార గుత్తాధిపత్యం (Trade Monopoly) రద్దు — కానీ చైనా వ్యాపారం మరియు టీ వ్యాపారం మాత్రం కంపెనీకే ఉంచారు
• క్రైస్తవ మిషనరీలకు (Christian Missionaries) భారతదేశంలో ప్రవేశించే అనుమతి

📌 చార్టర్ యాక్ట్ 1833:
• బెంగాల్ గవర్నర్ జనరల్‌ని "గవర్నర్ జనరల్ ఆఫ్ ఇండియా (Governor General of India)" గా మార్చారు
• మొదటి గవర్నర్ జనరల్ ఆఫ్ ఇండియా: లార్డ్ విలియమ్ బెంటింక్ (Lord William Bentinck)
• కంపెనీ వ్యాపార కార్యకలాపాలు పూర్తిగా నిలిపివేశారు — పూర్తిగా పాలనా సంస్థగా మారింది
• చట్ట రూపకల్పన అధికారం (Legislative Power) గవర్నర్ జనరల్ కౌన్సిల్‌కి

📌 చార్టర్ యాక్ట్ 1853:
• శాసనసభ (Legislative Council) మరియు కార్యనిర్వాహక మండలి (Executive Council) వేరు చేశారు
• శాసనసభలో స్థానిక ప్రాంత (local province) ప్రతినిధులను చేర్చారు (కానీ అసలు భారతీయుల నామినేషన్ ICA 1861లో వచ్చింది)
• సివిల్ సర్వీసెస్ (Civil Services) కోసం Open Competition ప్రవేశపెట్టారు

పరీక్ష ట్రిక్:
1813 → గుత్తాధిపత్యం రద్దు (Trade Monopoly ends)
1833 → G.G. of India (Bentinck) + వ్యాపారం పూర్తిగా రద్దు
1853 → Legislative + Executive వేరు + Civil Services Open"""
    },
    {
        "title": "1.4 గవర్నమెంట్ ఆఫ్ ఇండియా యాక్ట్ 1858",
        "sub": "GOI Act 1858 · Crown Rule Begins · Secretary of State for India · Viceroy · Lord Canning",
        "audio": """1857 సిపాయిల తిరుగుబాటు (Revolt of 1857) తర్వాత బ్రిటిష్ వారు నేర్చుకున్న పాఠం ఏమిటంటే — కంపెనీ పాలనపై ప్రత్యక్ష నియంత్రణ అవసరం.

📌 గవర్నమెంట్ ఆఫ్ ఇండియా యాక్ట్ 1858 (Government of India Act 1858) — ముఖ్యమైన అంశాలు:

1. కంపెనీ పాలన రద్దు: ఈస్ట్ ఇండియా కంపెనీ పాలన అంతమైంది — భారత పాలన నేరుగా బ్రిటిష్ క్రౌన్‌కు బదిలీ అయింది

2. "సెక్రటరీ ఆఫ్ స్టేట్ ఫర్ ఇండియా (Secretary of State for India)" పదవి సృష్టించారు:
   • బ్రిటిష్ కేబినెట్ మంత్రి
   • భారత పాలనకు బాధ్యుడు
   • 15 మంది కౌన్సిల్ సభ్యుల సహాయంతో పని చేసేవారు

3. "వైస్రాయ్ (Viceroy)" పదవి: గవర్నర్ జనరల్‌ను ఇప్పుడు వైస్రాయ్ అని పిలిచారు
   • మొదటి వైస్రాయ్: లార్డ్ కానింగ్ (Lord Canning)

4. Board of Control మరియు Court of Directors రద్దు అయ్యాయి

గుర్తుంచుకోండి:
• 1857 తిరుగుబాటు → 1858 చట్టం → కంపెనీ పాలన అంతం
• మొదటి వైస్రాయ్ = లార్డ్ కానింగ్
• సెక్రటరీ ఆఫ్ స్టేట్ = బ్రిటిష్ పార్లమెంట్‌కు జవాబుదారీ
• APPSC Group 2 లో ఈ చట్టం నుండి తప్పకుండా ప్రశ్న వస్తుంది!"""
    },

    {
        "title": "1.5 ఇండియన్ కౌన్సిల్స్ యాక్ట్స్ — 1861, 1892, 1909",
        "sub": "Indian Councils Acts · Portfolio System · Morley-Minto Reforms · Separate Electorate · Satyendra Prasad Sinha",
        "audio": """1858 తర్వాత బ్రిటిష్ వారు భారత పాలన వ్యవస్థను మెల్లగా మార్చుతూ వెళ్ళారు — ఈ మూడు యాక్ట్స్ ఆ ప్రయాణంలో కీలకమైన మైలురాళ్ళు.

📌 ఇండియన్ కౌన్సిల్స్ యాక్ట్ 1861:
• వైస్రాయ్ కౌన్సిల్‌లో శాసన నిర్మాణం కోసం మొదటిసారి భారతీయులను నామినేట్ (Nominate) చేయడం ప్రారంభమైంది
• బొంబాయి మరియు మద్రాస్ ప్రెసిడెన్సీలకు శాసన అధికారాలు పునరుద్ధరించారు (Decentralization)
• పోర్ట్‌ఫోలియో సిస్టమ్ (Portfolio System) ప్రవేశపెట్టారు — ప్రతి మంత్రికి నిర్దిష్ట శాఖ
• ప్రతినిధి ప్రభుత్వం (Representative Government) వైపు మొదటి అడుగు

📌 ఇండియన్ కౌన్సిల్స్ యాక్ట్ 1892:
• శాసన మండళ్ళలో అదనపు (Non-official) సభ్యుల సంఖ్య పెంచారు
• బడ్జెట్‌పై చర్చ మరియు ప్రశ్నలు అడగడానికి అనుమతి
• పరోక్ష ఎన్నికలు (Indirect Elections) ప్రారంభమయ్యాయి — అయినా నేరుగా ఎన్నికలు లేవు

📌 ఇండియన్ కౌన్సిల్స్ యాక్ట్ 1909 (మార్లే-మింటో రిఫార్మ్స్ | Morley-Minto Reforms):
• లార్డ్ మార్లే (Lord Morley) = సెక్రటరీ ఆఫ్ స్టేట్ | లార్డ్ మింటో (Lord Minto) = వైస్రాయ్
• మొదటిసారి ప్రత్యక్ష ఎన్నికలు (Direct Elections) — పరిమిత స్థాయిలో
• వైస్రాయ్ కార్యనిర్వాహక మండలిలో మొదటి భారతీయ సభ్యుడు: సత్యేంద్ర ప్రసాద్ సిన్హా (Satyendra Prasad Sinha)
• అత్యంత ముఖ్యమైన అంశం: ముస్లింలకు ప్రత్యేక నియోజకవర్గాలు (Separate Electorate for Muslims) — ఇది తర్వాత దేశ విభజనకు దారితీసిన విత్తనం!

గుర్తుంచుకోండి — ట్రిక్:
1861 → నామినేషన్ ప్రారంభం + Portfolio System
1892 → పరోక్ష ఎన్నికలు + బడ్జెట్ చర్చ
1909 → ప్రత్యక్ష ఎన్నికలు + Separate Electorate (Muslims) + మొదటి భారతీయ కార్యనిర్వాహక సభ్యుడు (సత్యేంద్ర ప్రసాద్ సిన్హా)"""
    },

    {
        "title": "1.6 గవర్నమెంట్ ఆఫ్ ఇండియా యాక్ట్ 1919",
        "sub": "Montagu-Chelmsford Reforms · Diarchy · Bicameral Legislature · Public Service Commission",
        "audio": """1919 యాక్ట్ — దీనినే మాంటేగు-చెమ్స్‌ఫర్డ్ రిఫార్మ్స్ (Montagu-Chelmsford Reforms) అంటారు.
మాంటేగు (Montagu) = సెక్రటరీ ఆఫ్ స్టేట్ | చెమ్స్‌ఫర్డ్ (Chelmsford) = వైస్రాయ్

📌 అత్యంత ముఖ్యమైన అంశం — ద్వంద్వ పాలన (Diarchy) రాష్ట్ర స్థాయిలో:
ప్రాంతీయ అంశాలను రెండుగా విభజించారు:
→ రిజర్వ్డ్ అంశాలు (Reserved Subjects): గవర్నర్ నేరుగా పాలించేవి (Finance, Law & Order, Land Revenue)
→ బదిలీ అంశాలు (Transferred Subjects): భారతీయ మంత్రులకు ఇచ్చినవి (Education, Health, Local Government)
ఈ వ్యవస్థ పనిచేయలేదు — 1935లో రద్దు అయింది.

📌 కేంద్రంలో ద్వి సభా వ్యవస్థ (Bicameral Legislature at Centre — మొదటిసారి!):
• కేంద్ర శాసనసభ (Central Legislative Assembly) — దిగువ సభ (Lower House)
• రాష్ట్ర మండలి (Council of State) — ఎగువ సభ (Upper House)

📌 ఇతర ముఖ్యమైన అంశాలు:
• కేంద్ర మరియు రాష్ట్ర బడ్జెట్‌లు వేరు చేశారు (Separation of Budgets)
• లోక్ సేవా సంఘం (Public Service Commission) ఏర్పాటు — UPSC పూర్వ రూపం
• ప్రత్యక్ష ఎన్నికలు విస్తరించారు (పరిమిత franchise)
• లండన్‌లో హై కమిషనర్ (High Commissioner for India) నియమించారు
• మత ప్రాతిపదిక నియోజకవర్గాలు (Communal Representation) విస్తరించారు

పరీక్ష కోసం రాసుకోండి:
1919 = Montagu-Chelmsford = రాష్ట్ర స్థాయిలో Diarchy + కేంద్రంలో Bicameral Legislature + PSC ఏర్పాటు"""
    },

    {
        "title": "1.7 గవర్నమెంట్ ఆఫ్ ఇండియా యాక్ట్ 1935",
        "sub": "GOI Act 1935 · Provincial Autonomy · All India Federation · RBI · Federal Court · Diarchy at Centre",
        "audio": """గవర్నమెంట్ ఆఫ్ ఇండియా యాక్ట్ 1935 (Government of India Act 1935) — స్వాతంత్ర్యానికి ముందు అత్యంత విస్తారమైన రాజ్యాంగ పత్రం (Constitutional Document). మన రాజ్యాంగంలో అనేక అంశాలు ఈ యాక్ట్ నుండే వచ్చాయి!

📌 అఖిల భారత సమాఖ్య (All-India Federation):
రాజ్యాంగ సభలు (Provinces) + స్వదేశీ సంస్థానాలు (Princely States) కలిపి ఏర్పాటు చేయాలని ప్రతిపాదించారు. కానీ సంస్థానాల నిరాకరణ వల్ల ఇది ఎప్పుడూ అమలు కాలేదు!

📌 రాష్ట్రాలకు స్వయంపాలన (Provincial Autonomy):
• రాష్ట్రాల్లో ద్వంద్వ పాలన (Diarchy) రద్దు అయింది
• రాష్ట్ర మంత్రులు శాసనసభకు జవాబుదారీగా ఉండే బాధ్యతాయుత ప్రభుత్వం (Responsible Government)
• కేంద్రంలో Diarchy ప్రతిపాదించారు — కానీ ఎప్పుడూ అమలు కాలేదు

📌 ఇతర కీలక అంశాలు:
• రిజర్వ్ బ్యాంక్ ఆఫ్ ఇండియా (RBI) స్థాపన — 1935లోనే!
• ఫెడరల్ కోర్ట్ (Federal Court) ఏర్పాటు — సుప్రీం కోర్ట్ పూర్వ రూపం
• 6 రాష్ట్రాల్లో ద్వి సభా వ్యవస్థ (Bicameral Legislature)
• కౌన్సిల్ ఆఫ్ ఇండియా (Council of India) రద్దు
• మత ప్రాతిపదిక నియోజకవర్గాలు మరింత విస్తరించారు

📌 మన రాజ్యాంగంతో సంబంధం:
భారత రాజ్యాంగంలో 70% కంటే ఎక్కువ అంశాలు 1935 యాక్ట్ నుండి వచ్చాయని చెప్తారు — శాసన వ్యవస్థ, కేంద్ర-రాష్ట్ర అధికారాల విభజన, అత్యవసర నిబంధనలు (Emergency Provisions), న్యాయ వ్యవస్థ మొదలైనవి.

గుర్తుంచుకోండి:
1935 = అత్యంత విస్తారమైన చట్టం + RBI + Federal Court + Provincial Autonomy + All-India Federation (అమలు కాలేదు)"""
    },

    {
        "title": "1.8 సైమన్ కమిషన్, రౌండ్ టేబుల్ కాన్ఫరెన్సులు మరియు ఇతర ఘట్టాలు",
        "sub": "Simon Commission 1927 · Round Table Conferences · August Offer 1940 · Cripps Mission 1942 · Cabinet Mission 1946",
        "audio": """స్వాతంత్ర్య పోరాటంలో బ్రిటిష్ వారు అనేక మిషన్‌లు, కాన్ఫరెన్సులు నిర్వహించారు — ప్రతిదీ పరీక్షలో వస్తుంది!

📌 సైమన్ కమిషన్ (Simon Commission) 1927-28:
• 1919 యాక్ట్ సమీక్ష కోసం 1927లో నియమించారు, 1928లో భారత్ వచ్చారు
• 7 మంది సభ్యులు — అందరూ బ్రిటిషర్లే! ఒక్క భారతీయుడు లేడు!
• "సైమన్ గో బ్యాక్ (Simon Go Back)" — దేశవ్యాప్త నిరసన
• అన్ని పార్టీలు బహిష్కరించాయి (Boycott)

📌 మూడు రౌండ్ టేబుల్ కాన్ఫరెన్సులు (Round Table Conferences):
• 1వ RTC (1930-31): కాంగ్రెస్ పాల్గొనలేదు — గాంధీజీ జైల్లో (Salt Satyagraha)
• 2వ RTC (1931): గాంధీజీ పాల్గొన్నారు — మతపరమైన విభేదాల వల్ల విఫలమైంది
• 3వ RTC (1932): కాంగ్రెస్ పాల్గొనలేదు — Communal Award ప్రకటించారు

📌 ఆగస్ట్ ఆఫర్ (August Offer) 1940:
• వైస్రాయ్ లిన్లిత్‌గో (Linlithgow) ప్రతిపాదన
• యుద్ధం తర్వాత డొమినియన్ స్టేటస్ (Dominion Status) ఇస్తామని వాగ్దానం
• కాంగ్రెస్ మరియు ముస్లిం లీగ్ రెండూ తిరస్కరించాయి

📌 క్రిప్స్ మిషన్ (Cripps Mission) 1942:
• సర్ స్టాఫర్డ్ క్రిప్స్ (Sir Stafford Cripps) నేతృత్వంలో వచ్చింది
• యుద్ధం తర్వాత డొమినియన్ స్టేటస్ ఇస్తామని వాగ్దానం
• గాంధీజీ దీన్ని "కూలిపోతున్న బ్యాంక్‌పై తేదీ ముందుకు వేసిన చెక్కు (Post-dated cheque on a crashing bank)" అన్నారు
• తిరస్కారం తర్వాత క్విట్ ఇండియా ఉద్యమం (Quit India Movement) 1942

📌 కేబినెట్ మిషన్ (Cabinet Mission) 1946:
• మూడు మంది సభ్యులు: పెథిక్-లారెన్స్ (Pethick-Lawrence), స్టాఫర్డ్ క్రిప్స్ (Cripps), A.V. అలెగ్జాండర్
• పాకిస్థాన్ డిమాండ్‌ను తిరస్కరించింది
• రాజ్యాంగ నిర్మాణ సభ (Constituent Assembly) ఏర్పాటు ప్రతిపాదన
• కాంగ్రెస్ అంగీకరించింది — ఇది స్వాతంత్ర్యానికి దారితీసింది

గుర్తుంచుకోండి:
Simon (1927-28) → RTC×3 (1930,31,32) → August Offer (1940) → Cripps (1942) → Cabinet Mission (1946) → Independence (1947)"""
    },

    {
        "title": "1.9 భారత స్వాతంత్ర్య చట్టం 1947 (Indian Independence Act 1947)",
        "sub": "IIA 1947 · Partition · Dominion Status · Lord Mountbatten · Cyril Radcliffe · August 15",
        "audio": """భారత స్వాతంత్ర్య చట్టం 1947 (Indian Independence Act 1947) — ఇది బ్రిటిష్ పార్లమెంట్ భారతదేశానికి ఇచ్చిన చివరి చట్టం. దీంతో మన స్వాతంత్ర్యం అధికారికమైంది!

📌 ముఖ్యమైన తేదీలు:
• జూలై 18, 1947 — బ్రిటిష్ పార్లమెంట్ ఈ చట్టానికి ఆమోదం తెలిపింది
• ఆగస్ట్ 15, 1947 — భారతదేశం మరియు పాకిస్థాన్ స్వతంత్ర దేశాలయ్యాయి

📌 ముఖ్యమైన నిబంధనలు:
1. British India రెండు Dominions గా విభజించబడింది: India మరియు Pakistan
2. రెండు దేశాలకు Dominion Status — పూర్తి స్వాతంత్ర్యం కాదు, Commonwealth లో సభ్యత్వం
3. రెండు దేశాలు తమ Constitutions తాము రూపొందించుకునే వరకు GOI Act 1935 ద్వారా పాలన కొనసాగింది
4. స్వదేశీ సంస్థానాలపై (Princely States) Paramountcy రద్దు — స్వేచ్ఛగా ఎక్కడైనా చేరవచ్చు
5. Secretary of State for India పదవి రద్దు అయింది

📌 Governor General పదవి:
• India మొదటి Governor General: Lord Mountbatten (1947-48)
• తర్వాత: C. Rajagopalachari (చక్రవర్తుల రాజగోపాలాచారి) — చివరి మరియు ఏకైక భారతీయ G.G.
• Pakistan మొదటి Governor General: Muhammad Ali Jinnah (Quaid-e-Azam)

📌 సరిహద్దు కమిషన్ (Boundary Commission):
• Sir Cyril Radcliffe నేతృత్వంలో సరిహద్దు గీయబడింది
• Radcliffe Line = India-Pakistan సరిహద్దు

పరీక్షలో గుర్తుంచుకోండి:
• IIA 1947 = July 18, 1947 ఆమోదం | Aug 15, 1947 అమలు
• మొదటి G.G. of India = Mountbatten | చివరి G.G. = C. Rajagopalachari
• Pakistan మొదటి G.G. = Jinnah | Boundary Commission = Radcliffe"""
    },

    {
        "title": "1.10 భారత రాజ్యాంగం యొక్క వనరులు (Sources of the Indian Constitution)",
        "sub": "UK · USA · Ireland · Canada · Australia · USSR · Germany · South Africa · Japan · France",
        "audio": """భారత రాజ్యాంగం (Indian Constitution) 'ఒకే రాజ్యాంగం' కాదు — ఇది ప్రపంచ రాజ్యాంగాల సారాన్ని సేకరించిన 'పుష్పగుచ్ఛం'! APPSC కు అత్యంత ముఖ్యమైన అంశం!

📌 ప్రధాన వనరులు (Main Sources) — TRICK తో గుర్తుంచుకోండి:

🇬🇧 బ్రిటన్ (UK) నుండి:
→ పార్లమెంటరీ వ్యవస్థ (Parliamentary System), ఏకపౌరసత్వం (Single Citizenship), Rule of Law, Cabinet System, Writ Jurisdiction (లేదా habeas corpus వంటివి)

🇺🇸 అమెరికా (USA) నుండి:
→ మూల హక్కులు (Fundamental Rights), స్వతంత్ర న్యాయ వ్యవస్థ (Independent Judiciary), Judicial Review, పీఠిక (Preamble) స్ఫూర్తి, Vice-President పదవి

🇮🇪 ఐర్లాండ్ (Ireland) నుండి:
→ ఆదేశిక సూత్రాలు (DPSP), Rajya Sabha కు నామినేషన్, రాష్ట్రపతి ఎన్నిక పద్ధతి (Proportional Representation)

🇨🇦 కెనడా (Canada) నుండి:
→ కేంద్ర బలంగా ఉన్న సమాఖ్య వ్యవస్థ (Federation with strong Centre), అవశేష అధికారాలు కేంద్రానికి (Residuary Powers)

🇦🇺 ఆస్ట్రేలియా (Australia) నుండి:
→ ఉమ్మడి జాబితా (Concurrent List), పార్లమెంట్ సంయుక్త సమావేశం (Joint Sitting)

🇷🇺 సోవియట్ యూనియన్ / USSR నుండి:
→ ప్రాథమిక విధులు (Fundamental Duties), పంచవర్ష ప్రణాళికల స్ఫూర్తి

🇩🇪 జర్మనీ (Weimar Republic) నుండి:
→ అత్యవసర కాలంలో మూల హక్కుల నిలిపివేత (Suspension of FRs during Emergency)

🇿🇦 దక్షిణ ఆఫ్రికా (South Africa) నుండి:
→ రాజ్యాంగ సవరణ విధానం (Amendment Procedure — Special Majority), Rajya Sabha సభ్యుల ఎన్నిక

🇯🇵 జపాన్ (Japan) నుండి:
→ చట్టం ద్వారా నిర్ణీత విధానం (Procedure Established by Law — Article 21)

🇫🇷 ఫ్రాన్స్ (France) నుండి:
→ రిపబ్లిక్ భావన, స్వేచ్ఛ-సమానత్వ-సౌభ్రాతృత్వం (Liberté, Égalité, Fraternité)

రాసుకోండి — APPSC లో తప్పకుండా వస్తుంది:
USA=FRs | Ireland=DPSP | Canada=Residuary Powers | Australia=Concurrent List | USSR=Fundamental Duties | Japan=Article 21 procedure"""
    },

    {
        "title": "1.11 అన్ని చట్టాల సమీక్ష — పోలిక పట్టిక (Comparative Review of All Acts)",
        "sub": "Quick Revision · All Acts Timeline · APPSC Pattern Questions · Match the Following",
        "audio": """పరీక్ష ముందు ఒక్కసారి అన్ని చట్టాలు గుర్తు చేసుకుందాం — ఇది మీ Quick Revision Section!

📊 కీలక చట్టాల పోలిక పట్టిక:

చట్టం | సంవత్సరం | అత్యంత ముఖ్యమైన లక్షణం
Regulating Act | 1773 | మొదటి నియంత్రణ చట్టం; Warren Hastings మొదటి G.G. of Bengal
Pitt's India Act | 1784 | Board of Control; Double Government / Diarchy
Charter Act | 1813 | వ్యాపార గుత్తాధిపత్యం పాక్షిక రద్దు; Missionaries అనుమతి
Charter Act | 1833 | G.G. of India (Bentinck); కంపెనీ వ్యాపారం పూర్తి రద్దు
Charter Act | 1853 | Legislative + Executive వేరు; Open Competition Civil Services
GOI Act | 1858 | కంపెనీ పాలన రద్దు; Secretary of State; మొదటి Viceroy = Canning
ICA | 1861 | Portfolio System; Nominations for Indians; Decentralization
ICA | 1892 | Indirect Elections; Budget Discussion
ICA | 1909 | Morley-Minto; Direct Elections; Separate Electorate (Muslims); Sinha
GOI Act | 1919 | Montagu-Chelmsford; State Diarchy; Bicameral Centre; PSC
GOI Act | 1935 | అత్యంత విస్తారమైన; RBI; Federal Court; Provincial Autonomy
IIA | 1947 | India + Pakistan; Mountbatten; Rajagopalachari; Radcliffe

📌 APPSC కు ముఖ్యమైన జంటలు (Important Pairs):
• మొదటి G.G. of Bengal = Warren Hastings (1773)
• మొదటి G.G. of India = Lord William Bentinck (1833)
• మొదటి Viceroy = Lord Canning (1858)
• మొదటి భారతీయ G.G. = C. Rajagopalachari (1948-50)
• Separate Electorate = 1909 | Diarchy = 1919 | RBI = 1935

పరీక్ష జోక్: "ఏ చట్టంలో ఏమి వచ్చింది?" అనే ప్రశ్నలు Match the Following రూపంలో వస్తాయి — ఈ పట్టిక మొత్తం గుర్తుపెట్టుకోండి!"""
    },

    {
        "title": "1.12 సినిమాటిక్ కథ — చారిత్రక నేపథ్యం (Cinematic Story: Historical Background)",
        "sub": "Full Chapter Story · Timeline 1600–1947 · All Key Facts Woven Together",
        "audio": """వ్యాపారులుగా వచ్చారు — చక్రవర్తులుగా మారారు. 1947లో వదిలి వెళ్ళారు — కానీ మన రాజ్యాంగంలో వారి చట్టాల ముద్ర మిగిలిపోయింది. అది ఏమిటో చూద్దాం.

━━━━━━━━━━━━━━━━━━━━
అధ్యాయం 1: వ్యాపారుల రాజ్యం (1600–1773)
The Company's Kingdom
━━━━━━━━━━━━━━━━━━━━
1600లో ఈస్ట్ ఇండియా కంపెనీ (East India Company) వ్యాపారానికి వచ్చింది. వందేళ్ళలో వ్యాపార సంస్థ రాజ్యం స్థాపించింది. బ్రిటిష్ పార్లమెంట్ కంగారు పడింది — "ఈ వ్యాపారస్తులు మన మాట వినడం లేదు!" అందుకే 1773లో Regulating Act వచ్చింది. మొదటిసారి నియంత్రణ. వారెన్ హేస్టింగ్స్ మొదటి గవర్నర్ జనరల్ అయ్యారు. కలకత్తాలో సుప్రీం కోర్ట్ పుట్టింది.

━━━━━━━━━━━━━━━━━━━━
అధ్యాయం 2: మూడు చార్టర్ యాక్ట్‌ల కాలం (1813–1853)
The Charter Era
━━━━━━━━━━━━━━━━━━━━
1813 — వ్యాపార గుత్తాధిపత్యం పోయింది. మిషనరీలు వచ్చారు. 1833 — కంపెనీ వ్యాపారం పూర్తిగా ఆగిపోయింది. లార్డ్ బెంటింక్ 'గవర్నర్ జనరల్ ఆఫ్ ఇండియా' అయ్యారు — ఇప్పుడు మొత్తం భారతదేశానికి ఒకే పాలకుడు. 1853 — శాసన మరియు కార్యనిర్వాహక మండళ్ళు వేరయ్యాయి. సివిల్ సర్వీసెస్‌కు Open Competition వచ్చింది — తెలివైన భారతీయులు ప్రభుత్వంలో చేరగలిగారు.

━━━━━━━━━━━━━━━━━━━━
అధ్యాయం 3: 1857 — మార్పు రోజు (1858)
The Day Everything Changed
━━━━━━━━━━━━━━━━━━━━
1857 సిపాయిల తిరుగుబాటు బ్రిటిష్ వారిని కదిలించింది. "కంపెనీ వల్ల అవుతుందా?" అని బ్రిటిష్ పార్లమెంట్ నిర్ణయించింది — 1858లో కంపెనీ పాలన అంతమైంది. క్రౌన్ పాలన ప్రారంభమైంది. లార్డ్ కానింగ్ మొదటి వైస్రాయ్ అయ్యారు. సెక్రటరీ ఆఫ్ స్టేట్ పదవి వచ్చింది. 85 సంవత్సరాల కంపెనీ పాలన ముగిసింది.

━━━━━━━━━━━━━━━━━━━━
అధ్యాయం 4: మెల్లగా మారే పాలన (1861–1909)
Slow Steps Toward Representation
━━━━━━━━━━━━━━━━━━━━
1861 — భారతీయులకు మొదటిసారి నామినేషన్ దక్కింది. Portfolio System వచ్చింది. 1892 — పరోక్ష ఎన్నికలు వచ్చాయి. 1909 — మార్లే-మింటో రిఫార్మ్స్ వచ్చాయి. Direct Elections వచ్చాయి. సత్యేంద్ర ప్రసాద్ సిన్హా మొదటి భారతీయ కార్యనిర్వాహక సభ్యుడు అయ్యారు. కానీ — ముస్లింలకు Separate Electorate వచ్చింది. ఆ ఒక్క నిర్ణయం తర్వాత 38 సంవత్సరాలకు దేశ విభజనకు దారి తీసింది.

━━━━━━━━━━━━━━━━━━━━
అధ్యాయం 5: Diarchy మరియు పోరాటం (1919–1935)
Diarchy and the Struggle
━━━━━━━━━━━━━━━━━━━━
1919 — మాంటేగు-చెమ్స్‌ఫర్డ్ రిఫార్మ్స్ వచ్చాయి. రాష్ట్రాల్లో Diarchy ప్రారంభమైంది — కానీ భారతీయులకు అది సరిపోలేదు. 1927లో Simon Commission వచ్చింది — ఒక్క భారతీయుడు లేడు. "Simon Go Back" అరుపులు మారుమోగాయి. మూడు రౌండ్ టేబుల్ కాన్ఫరెన్సులు జరిగాయి — ఫలితం లేకపోయింది. 1935లో GOI Act వచ్చింది — అత్యంత విస్తారమైన చట్టం. RBI పుట్టింది. Federal Court వచ్చింది. Provincial Autonomy వచ్చింది.

━━━━━━━━━━━━━━━━━━━━
అధ్యాయం 6: చివరి యుద్ధం మరియు స్వాతంత్ర్యం (1940–1947)
The Final Battle
━━━━━━━━━━━━━━━━━━━━
1940 — August Offer వచ్చింది — తిరస్కరించారు. 1942 — Cripps Mission వచ్చింది. గాంధీజీ "కూలిపోతున్న బ్యాంక్‌పై చెక్కు" అన్నారు. Quit India Movement మొదలైంది. 1946 — Cabinet Mission వచ్చింది — Constituent Assembly ఏర్పాటు ప్రతిపాదించారు. 1947 జూలై 18 — Indian Independence Act బ్రిటిష్ పార్లమెంట్ ఆమోదించింది. ఆగస్ట్ 15, 1947 — India మరియు Pakistan స్వతంత్ర దేశాలయ్యాయి. 89 సంవత్సరాల క్రౌన్ పాలన అంతమైంది.

━━━━━━━━━━━━━━━━━━━━
గుర్తుంచుకోండి — Grand Timeline:
━━━━━━━━━━━━━━━━━━━━
1773 (Regulating Act) → 1784 (Pitt's) → 1813 → 1833 → 1853 (Charter Acts) → 1858 (Crown Rule) → 1861 → 1892 → 1909 (Indian Councils Acts) → 1919 (Diarchy) → 1935 (Provincial Autonomy + RBI + Federal Court) → 1947 (Independence) ✨

మన రాజ్యాంగం అనేది ఈ 174 సంవత్సరాల చరిత్ర నుండి పుట్టింది — పరీక్షలో రాయడానికే కాదు, అర్థం చేసుకోవడానికి కూడా!"""
    },
]
...
def _seed_polity_ch1_notes_inner(conn, db_exec_fn, row_to_dict_fn, use_postgres, force=False):
    ...
    if row and not force:
        return {'success': True, 'already_exists': True,
                'message': 'Polity Ch1 notes already seeded.'}
    if row and force:
        db_exec_fn(conn,
    ...
    db_exec_fn(conn,
        ...
        ('GK', 'Indian_Polity', '', 1,
         ...
         'Ch.1',
         _json.dumps(POLITY_CH1_SECTIONS, ensure_ascii=False)))
    conn.commit()
    return {'success': True, 'message': 'Polity Ch1 notes seeded!'}


def _seed_polity_ch1_mcqs_inner(conn, db_exec_fn, row_to_dict_fn, use_postgres):
    ph = '%s' if use_postgres else '?'
    ...
    row = cur.fetchone()
    if not row:
        _seed_polity_ch1_notes_inner(conn, db_exec_fn, row_to_dict_fn, use_postgres)
        cur = db_exec_fn(conn,
            f"SELECT id FROM study_notes WHERE chapter_num={ph} AND topic={ph}",
            (1, 'Indian_Polity'))
        row = cur.fetchone()
    ...
    total = len(POLITY_CH1_MCQS)
    return {
        'success': True,
        'message': f'Polity Ch1 MCQs seeded! Total: {total}',
        'inserted': total,
