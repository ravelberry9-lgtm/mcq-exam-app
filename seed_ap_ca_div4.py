...
MCQ_DATA = [
    ...
    (4, 2,
     ...
     "b",
     "ఫిబ్రవరి 18-25, 2026 సమయంలో రాష్ట్రపతి ద్రౌపది ముర్ము INS సుమేధా (Sumedha) నౌకపై నుండి IFR 2026 జరిపారు. INS సుమేధా స్వదేశీ నిర్మిత Offshore Patrol Vessel (OPV). ఇది భారత్ నిర్వహించిన 13వ President's Fleet Review."),
    ...
    (9, 1,
     ...
     "c",
     "హరీష్ కుమార్ గుప్తా (IPS 1992 batch, AP cadre) జనవరి 31, 2025 నుండి AP DGP & Head of Police Force గా 2 సంవత్సరాల నిర్ణీత పదవీ కాలంతో నియమించారు (నిర్ణీతం, May 19 నుండి 474 రోజుల జీవన్కాలం). వరుస నిర్వహణ: చీఫ్ సెక్రటరీ పరిధిలో పనిచేస్తున్నారు."),

    (9, 1,
     "AP Chief Secretary గా మార్చి 1, 2026 నుండి ఎవరు నియమించారు?",
     "K. విజయానంద్", "నీరబ్ కుమార్ ప్రసాద్", "G. సాయి ప్రసాద్", "Y.V. ఆనంద రావు",
     "c",
     "G. సాయి ప్రసాద్ (IAS 1991 batch, Special Chief Secretary Water Resources) మార్చి 1, 2026 నుండి AP Chief Secretary గా నియమించారు (నిర్ణీతం, May 19 నుండి 80 రోజుల జీవన్కాలం). K. విజయానంద్ (IAS 1992 batch) ఫిబ్రవరి 28, 2026న పదవీ విరమణ చేశారు. G. సాయి ప్రసాద్ కు డిసెంబర్ 31, 2026 వరకు సేవా కాలం ఎక్కువ."),
    ...
    (16, 1,
     ...
     "a",
     "జనవరి 4, 2026న ఢిల్లీ నుండి మొదటి validation flight ల్యాండ్ అయింది (నిర్ణీతం, May 19 నుండి 135 రోజుల క్రితం). PM నరేంద్ర మోదీ జూన్ 26, 2026న (May 19 నుండి 38 నెలల లక్ష్యం) commercial inauguration చేయనున్నారు. నిర్మాణ సంస్థ: GMR Group, విజయనగరం జిల్లా."),
