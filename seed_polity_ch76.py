...
_MCQ_DATA = [    (0,
     'easy',
     'Under Art.299 all Govt contracts shall be expressed to be made by whom?\nతెలుగు: Art.299 ప్రకారం Government contract ఎవరి పేరిట express చేయాలి?',
     'Prime Minister/Chief Minister',
     'President/Governor respectively for Union/State',
    ...
    (0,
     'medium',
     'What are the requirements for a valid government contract under Art.299?\nతెలుగు: Art.299 contract requirements ఏమిటి?',
     'Only oral agreement needed',
     'Must be: (1) expressed in name of President/Governor; (2) executed by duly authorised person; (3) in writing',
     'Only Presidential approval',
     'Only Parliamentary ratification',
     'b',
    ...
    (0,
     'easy',
     'Can Union of India be sued under Art.300?\nతెలుగు: Art.300 ప్రకారం Union of India ని suit చేయవచ్చా?',
     'No, cannot be sued',
     "Yes — Union of India may sue and be sued in name 'Union of India'",
     'Only by foreign countries',
     'Only by States',
     'b',
    ...
    (0,
     'hard',
     'What happens if Art.299 formalities are not complied with?\nతెలుగు: Art.299 comply చేయకపోతే ఏమవుతుంది?',
     'Contract becomes void',
     'Contract is not enforceable against Government — Government not bound; officer who contracted may be personally liable',
     'Contract is enforceable against officer only',
     'Contract binds Parliament',
     'b',
    ...
    (0,
     'medium',
     'On what predecessor does Art.300 base itself?\nతెలుగు: Art.300 ఏ predecessor provision based గా ఉంది?',
     'Completely new provision',
     'Based on pre-constitution law: Secretary of State in Council → Dominion of India → Union of India; preserved continuity of suits',
     'Based on British Crown Proceedings Act',
     'Based on Govt of India Act 1919',
     'b',
    ...
    (0,
     'easy',
     'In a suit against Union of India, to whom must notice be given?\nతెలుగు: Union of India ని suit చేసే case లో plaintiff ఎవరికి notice ఇవ్వాలి?',
     'To the Prime Minister',
     'To the concerned ministry/department — Section 80 CPC: 2-month notice to Union of India before filing suit',
     'To Parliament',
     'No notice required',
     'b',
    ...
    (0,
     'medium',
     'What does Art.299(2) protect an officer from?\nతెలుగు: Art.299(2) officer ని ఏ నుండి protect చేస్తుంది?',
     'Criminal prosecution',
     'Personal liability for contracts made in their official capacity on behalf of Govt — they are not personally liable for bona fide Govt contracts',
     'Tax liability',
    ...
    (0,
     'hard',
     'Under Art.300, in whose name must a State file or defend a suit?\nతెలుగు: Art.300 ప్రకారం State suit ఎవరి పేరిట file చేయబడుతుంది?',
     "In the CM's name",
     "In the name of the State itself — 'State of [Name]' (e.g., State of Maharashtra)",
    ...
    (1,
     'easy',
     'In which case was the Sovereign Immunity doctrine first established in India?\nతెలుగు: Sovereign Immunity doctrine ఏ case లో establish అయింది India లో?',
     'Kasturilal 1965',
     'P&O Steam Navigation Co. v. Secretary of State for India (1861) — Calcutta HC',
     'Vidyawati 1962',
     'Rudul Shah 1983',
     'b',
    ...
    (1,
     'medium',
     'What is the distinction between sovereign and non-sovereign functions?\nతెలుగు: Sovereign functions vs Non-sovereign functions distinction ఏమిటి?',
     'Based on budget allocation',
     'Sovereign = acts of state (army, war, waging peace, legislation) → immunity; Non-sovereign = commercial, trade, maintenance activities → full liability like private person',
     'Based on employee grade',
    ...
    (1,
     'easy',
     'What was the Kasturilal case about?\nతెలుగు: Kasturilal v. State of UP (1965) case ఏమిటి?',
     'Railway accident',
     'Police seized gold from a merchant (Kasturilal); police kept/lost the gold through negligence; SC held seizure = sovereign function → State not liable',
     'Custodial death',
     'Road accident by Govt vehicle',
     'b',
    ...
    (1,
     'hard',
     'Why do critics criticise the Kasturilal decision?\nతెలుగు: Kasturilal case ని critics ఎందుకు criticise చేస్తారు?',
     'Case decided correctly',
     'Anachronistic in welfare state — where State performs vast activities, blanket immunity is unjust; modern SC cases have narrowed this ruling; 21st Law Commission recommended abolition of sovereign/non-sovereign distinction',
     'Kasturilal won',
     'Decision was criminal, not civil',
     'b',
    ...
    (1,
     'medium',
     'Under which Act was Crown immunity abolished in UK?\nతెలుగు: UK లో Crown Immunity ఏ Act తో abolish అయింది?',
     'Crown Rights Act 1950',
     'Crown Proceedings Act 1947 — Crown (Government) can be sued like any person; sovereign immunity largely abolished in England',
     'Crown Liability Act 1960',
     'Government Torts Act 1945',
     'b',
    ...
    (1,
     'easy',
     'Which of the following is an example of a sovereign function?\nతెలుగు: Sovereign function ఉదాహరణ ఏమిటి?',
     'Operating a bus service',
     'Maintaining army and defence of the country',
     'Running a canteen',
    ...
    (1,
     'hard',
     'Which is an example of a non-sovereign function where State is liable?\nతెలుగు: Non-sovereign function ఉదాహరణ ఏమిటి?',
     'Waging war',
     'Operating a government-owned passenger bus service — commercial activity → State liable for negligence of driver',
     'Making a law',
     'Foreign treaty',
     'b',
    ...
    (1,
     'medium',
     'How has the sovereign immunity doctrine evolved in India?\nతెలుగు: Sovereign immunity doctrine India లో ఎలా evolve అయింది?',
     'Expanded over time',
     'Progressively narrowed by courts — from P&O 1861 broad immunity → Kasturilal 1965 → Vidyawati 1962 (before Kasturilal) → post-1983 constitutional tort remedy → courts limit immunity greatly',
     'No change',
     'Fully abolished by legislation',
     'b',
    ...
    (2,
     'easy',
     'What was the Vidyawati case about?\nతెలుగు: Vidyawati case (1962) ఏమిటి?',
     'Custodial death',
     "State of Rajasthan v. Vidyawati (1962) — Govt jeep driver's negligence caused road accident and death; SC: driving Govt vehicle = non-sovereign function → State liable",
    ...
    (2,
     'medium',
     'What principle did Rudul Shah (1983) establish?\nతెలుగు: Rudul Shah v. State of Bihar (1983) ఏ principle establish చేసింది?',
     'Sovereign immunity applies to prisons',
     'SC can award monetary compensation under Art.32 for violation of fundamental rights — constitutional tort; Rudul Shah was illegally detained for 14 years after acquittal; SC awarded compensation',
     'Govt jeep case',
     'Police immunity',
     'b',
    ...
    (2,
     'easy',
     'What was Nilabati Behera about?\nతెలుగు: Nilabati Behera v. State of Orissa (1993) ఏమిటి?',
     'Environmental pollution',
     'Son of Nilabati Behera died in police custody (custodial death); SC awarded compensation under Art.32 — State liable for custodial death, not a sovereign function',
     'Road accident',
    ...
    (2,
     'medium',
     'What was D.K. Basu (1997) about?\nతెలుగు: D.K. Basu v. State of WB (1997) ఏమిటి?',
     'Environmental guidelines',
     'Custodial torture/death guidelines — SC laid down specific guidelines for arrest, detention, custody; State liable for custodial violence; compensation payable for violation of Art.21',
     'PIL on education',
     'Forest protection',
     'b',
    ...
    (2,
     'hard',
     'What was Chandrima Das (2000) about?\nతెలుగు: Chairman Railway Board v. Chandrima Das (2000) ఏమిటి?',
     'Railway land acquisition',
     "Rape of a Bangladeshi national by railway employees on railway premises; SC: Indian Railways (Union of India) liable; rape by employees on employer's premises = non-sovereign act; compensation awarded",
     'Train derailment',
     'Railway contract',
     'b',
    ...
    (2,
     'easy',
     'What was Sebastian Hongray about?\nతెలుగు: Sebastian Hongray v. Union of India (1984) ఏమిటి?',
     'Environmental case',
     'SC awarded exemplary costs (compensation) when two persons taken into Army custody disappeared — disappeared/killed in custody → Army violated Art.21; SC ordered compensation',
     'Land reform case',
     'Election petition',
     'b',
    ...
    (2,
     'medium',
     "What is a 'Constitutional Tort'?\nతెలుగు: 'Constitutional Tort' అంటే ఏమిటి?",
     'Tort under IPC',
     'Violation of fundamental rights by State giving rise to right to compensation directly under Art.32 or Art.226 — bypasses sovereign immunity doctrine',
     'Tort under Contract Act',
     'Only available in civil courts',
     'b',
    ...
    (2,
     'hard',
     'What did the 21st Law Commission recommend on sovereign immunity?\nతెలుగు: 21st Law Commission ఏ recommendation ఇచ్చింది sovereign immunity పై?',
     'Expand sovereign immunity',
     'Abolish the sovereign/non-sovereign distinction — State should be liable for all tortious acts of its employees regardless of nature of function; recommend enactment of a Government Liability Act',
     'Maintain status quo',
     'Only abolish for criminal cases',
     'b',
    ...
    (3,
     'easy',
     'How many essentials are there for a valid Govt contract under Art.299?\nతెలుగు: Art.299 ప్రకారం valid Govt contract కోసం ఎన్ని essentials ఉన్నాయి?',
     'Two',
     'Three — (1) expressed in name of President/Governor; (2) executed by duly authorised person; (3) must be in writing',
     'Four',
     'Five',
     'b',
    ...
    (3,
     'medium',
     'What happens to an officer who fails to comply with Art.299(1) formalities?\nతెలుగు: Art.299(1) formalities comply చేయని officer ఏమవుతారు?',
     'Officer gets protection',
     'Officer may be personally liable for the contract — the Govt is not bound; the other party can sue the officer personally but not the Govt',
     'Govt still bound',
    ...
    (3,
     'easy',
     'What if a Govt contract is not in writing?\nతెలుగు: Govt contract writing లో ఉండకపోతే ఏమవుతుంది?',
     'Still valid',
     'Not enforceable against the Government — writing is a mandatory requirement under Art.299',
    ...
    (3,
     'medium',
     "What does 'executed in executive capacity' mean for Govt contracts?\nతెలుగు: Government contract 'executive capacity లో' execute అవ్వాలంటే ఏమిటి అర్థం?",
     'Executed by minister personally',
     'Executed by an officer duly authorised by President/Governor — following proper delegation of authority chain within Govt',
     'Executed only by Secretary',
     'Executed by courts',
     'b',
    ...
    (3,
     'hard',
     'Why does Art.299 protect the Government in contracts?\nతెలుగు: Art.299 ఎందుకు Government ని contracts లో protect చేస్తుంది?',
     'To make contracts difficult',
     'To prevent ultra-vires contracts binding Govt: ensures only authorised officers can bind Govt; formalities prevent fraud/forgery; protects public funds; prevents officers from exceeding authority and binding Govt in unauthorised ways',
     'To help private parties',
     'To ensure taxation',
     'b',
    ...
    (3,
     'easy',
     "Why is the 'writing' requirement in Art.299?\nతెలుగు: Govt contract లో 'written' requirement ఎందుకు ఉంది?",
     'For tax records',
     'To ensure clarity, prevent disputes, and maintain records — written contracts create clear evidence of terms; prevents fraudulent claims against Govt',
     'To delay contracts',
     'Oral is cheaper',
     'b',
    ...
    (3,
     'medium',
     'Does the Government protect an officer who violates Art.299?\nతెలుగు: Art.299 ని violate చేసిన officer ని Govt protect చేస్తుందా?',
     'Always protects',
     "No — Art.299(2) protects officers only for contracts made properly in official capacity. If officer violates Art.299(1), officer is personally liable; Govt protection (Art.299(2)) doesn't apply",
     'Always officer protected',
     'Govt must pay instead',
     'b',
    ...
    (3,
     'hard',
     'Which English case principle is relevant to Govt contract law?\nతెలుగు: Government contract law related ఏ English case relevant?',
     'Donoghue v. Stevenson',
     "Fibrosa v. Fairbairn — frustration of contract; and Secretary of State for India cases established that Govt contracts must follow constitutional formalities; 'executive necessity' doctrine says Govt cannot be estopped from exercising statutory powers",
     'Donoghue principle',
     'Rylands v. Fletcher',
     'b',
    ...
    (4,
     'easy',
     'Why is sovereign immunity anachronistic in a welfare state?\nతెలుగు: Welfare state లో sovereign immunity anachronistic ఎందుకు?',
     'Sovereign states are perfect',
     'Welfare state performs vast range of activities (health, education, transport, housing) beyond traditional sovereign acts — blanket immunity unjust for routine activities causing harm to citizens',
     'Welfare state has no police',
     'Colonial era',
     'b',
    ...
    (4,
     'medium',
     'Does India have comprehensive legislation for Government torts?\nతెలుగు: India లో Govt torts కి comprehensive legislation ఉందా?',
     'Yes — Govt Liability Act 2001',
     'No comprehensive legislation — unlike UK (Crown Proceedings Act 1947); India relies on case-by-case judicial evolution; constitutional tort under Art.32/226',
     'Yes — Civil Liability Act 2010',
     'Yes — Tort Reform Act 1995',
     'b',
    ...
    (4,
     'easy',
     'Does vicarious liability apply to Govt for employee negligence?\nతెలుగు: Government employee negligence లో vicarious liability apply అవుతుందా?',
     'Never applies',
     'Yes — for non-sovereign functions; Govt (employer) vicariously liable for negligence of its employees (servants) in course of non-sovereign duties; like private employer-employee relationship',
     'Only for IAS officers',
     'Only for police',
     'b',
    ...
    (4,
     'medium',
     "What is an example of 'negligence per se' in Govt liability?\nతెలుగు: Tort liability లో 'negligence per se' కి example ఏమిటి?",
     'Policy decision error',
     "Government hospital — doctor's negligence causing patient death/injury — State Hospital running = non-sovereign function → State vicariously liable for doctor's negligence",
     'Army promotion decision',
    ...
    (4,
     'hard',
     "Does 'Absolute Liability' doctrine apply to the Government?\nతెలుగు: 'Absolute Liability' doctrine Govt ని కూడా apply అవుతుందా?",
     'Never applies to Govt',
     'Yes — MC Mehta case established absolute liability for inherently dangerous enterprises; if Govt runs inherently dangerous enterprise causing harm → absolute liability regardless of sovereign/non-sovereign distinction',
    ...
    (4,
     'easy',
     'Can the Government sue a person who damages Government property?\nతెలుగు: Government property ని damage చేసిన person ని sue చేయవచ్చా?',
     'No, Govt cannot sue',
     'Yes — Govt can sue any person for damages to Govt property in civil courts; files suit as Union of India/State of [Name]',
     'Only criminal action possible',
     'Only through police',
     'b',
    ...
    (4,
     'medium',
     'Does strict liability apply to the Government?\nతెలుగు: Strict liability Govt ని apply అవుతుందా?',
     'Never applies',
     'Yes — for non-sovereign activities; Rylands v. Fletcher principle: if Govt accumulates something dangerous on land that escapes and causes harm → strictly liable (no immunity for non-sovereign activities)',
    ...
    (4,
     'hard',
     'Distinguish between policy decisions and operational failures in Govt liability.\nతెలుగు: Policy decisions vs Operational failures — distinguish చేయి?',
     'Both attract same liability',
     "Policy decisions (high-level discretionary choices on how to govern) → generally immunised from tort liability (non-justiciable); Operational failures (implementing the policy negligently) → State liable; 'policy-operational' distinction used in negligence",
     'Both immune',
     'Both attract liability',
     'b',
    ...
    (5,
     'easy',
     'What does CPC Section 80 provide?\nతెలుగు: CPC Section 80 ఏమిటి?',
     'Stay of Govt suits',
     '2-month notice required before filing civil suit against Central or State Government or any public officer in official capacity; failure to give notice → suit not maintainable',
     '6-month notice',
     '1-year notice',
     'b',
    ...
    (5,
     'medium',
     'What must be specified in a CPC Sec.80 notice?\nతెలుగు: CPC Sec.80 notice లో ఏమేమి specify చేయాలి?',
     "Only plaintiff's name",
     'Cause of action + relief sought + name and address of plaintiff/claimant; complete notice enables Govt to consider settling before litigation',
     'Only amount claimed',
     'Only date of incident',
     'b',
    ...
    (5,
     'easy',
     'Can Sec.80 notice be waived in urgent cases?\nతెలుగు: Urgent cases లో Sec.80 notice ఇవ్వకపోవచ్చా?',
     'Never waived',
     'Yes — 2002 Amendment to CPC: courts may allow suit without prior notice in urgent cases if the court is satisfied it is so urgent; court gives leave to sue without notice',
     'Always waived',
     'Only if Govt agrees',
     'b',
    ...
    (5,
     'medium',
     'What is the consequence of failing to give Sec.80 notice?\nతెలుగు: Sec.80 notice failure ఏ consequence ఉంది?',
     'Reduced compensation only',
     'Suit is not maintainable — court will dismiss/reject the suit on this ground alone; plaintiff must start afresh with proper notice',
     'Only penalty payable',
     'Delay in trial only',
     'b',
    ...
    (5,
     'hard',
     'What purpose does Sec.80 notice serve?\nతెలుగు: Sec.80 notice ఏ purpose serve చేస్తుంది?',
     'Delay tactics only',
     'Gives Govt opportunity to (1) investigate the claim; (2) settle the matter without litigation; (3) take corrective action; (4) prepare defence; reduces unnecessary litigation against Govt',
     'Only revenue purposes',
     'Only historical',
     'b',
    ...
    (5,
     'easy',
     'What role does the Attorney General play in Govt suits?\nతెలుగు: Govt suit లో Attorney General ఏ role పోషిస్తారు?',
     'AG decides all Govt suits',
     'AG is the primary law officer of Union of India — represents Union in SC cases; gives legal advice to Govt; assists in Govt suits before SC; AGs of States represent respective State Governments in HC',
     'AG decides damages',
     'AG signs all notices',
     'b',
    ...
    (5,
     'medium',
     'Does Limitation Act apply to Government suits?\nతెలుగు: Government suit కి Limitation Act apply అవుతుందా?',
     'No — Govt has no limitation',
     'Yes — Limitation Act 1963 applies to Govt suits too (historically Govt had longer limitation periods but now standardised); Govt must file suits within prescribed limitation periods',
     'Govt has 30 years always',
     'Only foreign limitation',
     'b',
    ...
    (5,
     'hard',
     "Does the 'doctrine of estoppel' apply when suing the Government?\nతెలుగు: Govt ని sue చేయడం లో 'doctrine of estoppel' apply అవుతుందా?",
     'Always applies fully',
     'Limited application — Govt cannot be estopped from performing statutory duties/exercising statutory powers; BUT promissory estoppel may apply if Govt makes a clear and unambiguous promise, person acts in reliance, detriment results (Motilal Sugar Mills principle)',
     'Never applies',
    ...
    (6,
     'easy',
     'What does Art.361 protect the President from?\nతెలుగు: Art.361 President ని ఏ నుండి protect చేస్తుంది?',
     'Parliamentary impeachment',
     'Criminal proceedings and civil proceedings during term — no criminal proceedings against President/Governor during term; 2-month notice for civil proceedings; no arrest/imprisonment during term',
     'Tax obligations',
     'International law',
     'b',
    ...
    (6,
     'medium',
     'How is Art.361 different from Parliamentary Privilege?\nతెలుగు: Art.361 vs Parliamentary Privilege తేడా ఏమిటి?',
     'Same as Parliamentary Privilege',
     'Art.361: Executive immunity — protects President/Governor from courts during term; Parliamentary Privilege (Art.105/194): Legislative immunity — protects MP/MLA from courts for things said/voted in House; different in nature and scope',
     'Art.361 is subset of Art.105',
     'No difference',
     'b',
    ...
    (6,
     'easy',
     'What does Section 123 of Indian Evidence Act provide?\nతెలుగు: Indian Evidence Act Section 123 ఏమిటి?',
     'Expert witness rules',
     'Unpublished official records — state affairs documents — not to be given in evidence without permission of head of department/minister; government privilege against disclosure of state secrets',
     'Hearsay rule',
    ...
    (6,
     'medium',
     'What can the court do after a Sec.123 privilege claim?\nతెలుగు: Evidence Act Sec.123 claim చేసిన తరువాత court ఏమి చేయవచ్చు?',
     'Must accept privilege always',
     "Court can inspect the document itself to decide whether to uphold the privilege; court balances public interest in disclosure vs public interest in maintaining secrecy; court is not bound by Govt's claim",
     'Must reject privilege always',
     'Must refer to President',
     'b',
    ...
    (6,
     'hard',
     'What does Art.361 NOT protect the Governor from?\nతెలుగు: Art.361 Governor ని ఏమి నుండి protect చేయదు?',
     'Civil suits during term',
     "Personal acts outside official capacity — Art.361 protects only for exercise of powers/duties of office; personal acts (not done as Governor) not protected; also doesn't protect from Removal by President (Art.156), or HC jurisdiction on certain matters",
     'Official decisions',
     'Policy matters',
     'b',
    ...
    (6,
     'easy',
     'What does Evidence Act Section 124 provide?\nతెలుగు: Evidence Act Sec.124 ఏమిటి?',
     'Expert evidence',
     'Official communications — any public officer may claim privilege against disclosing official communications if disclosure would be against public interest; head of department decides',
     'Witness immunity',
     'Criminal evidence',
     'b',
    ...
    (6,
     'medium',
     'What notice is required for civil proceedings against President/Governor under Art.361?\nతెలుగు: Art.361 లో civil proceedings కి notice ఎంత?',
     'No notice needed',
     '2-month notice required before civil proceedings against President/Governor; no arrest or imprisonment during term; same as Sec.80 CPC but specified in Constitution itself for President/Governor',
     '1-month notice',
     '6-month notice',
     'b',
    ...
    (6,
     'hard',
     'Does Art.361 fully protect the President from all court accountability?\nతెలుగు: Art.361 President ని ఏ court accountability నుండి fully protect చేస్తుందా?',
     'Yes, total immunity forever',
     "No — not full immunity: (1) Post-term: personal acts may be liable; (2) Art.361 ≠ protection from impeachment (Parliament's power — Art.61); (3) Courts can review Presidential proclamations under Art.356 (S.R. Bommai 1994); (4) Art.361 protects exercise of powers, not legislative power of President to promulgate ordinances (Art.123) — courts review ordinances",
     'Yes — even after term',
     'Yes, from all courts',
     'b',
    ...
    (7,
     'easy',
     'In which part of the Constitution is Art.299?\nతెలుగు: Art.299 ఏ chapter లో ఉంది?',
     'Part III',
    ...
    (7,
     'medium',
     'In which court and year was the P&O case decided?\nతెలుగు: P&O Case ఏ court లో decided అయింది ఏ year లో?',
     'SC Delhi 1950',
     'Calcutta High Court, 1861 — P&O Steam Navigation Co. v. Secretary of State for India; established sovereign/non-sovereign distinction',
     'Bombay HC 1900',
     'Madras HC 1885',
     'b',
    ...
    (7,
     'easy',
     'In which year was the Rudul Shah case decided?\nతెలుగు: Rudul Shah case ఏ year లో?',
     '1975',
     '1983 — Rudul Shah v. State of Bihar; first SC monetary compensation award under Art.32 for FR violation (14 years illegal detention after acquittal)',
     '1990',
     '2000',
     'b',
    ...
    (7,
     'medium',
     'In which year was Kasturilal decided?\nతెలుగు: Kasturilal v. State of UP ఏ year లో?',
     '1960',
     "1965 — Kasturilal Ralia Ram Jain v. State of UP; SC upheld sovereign immunity for police seizure of property (gold merchant's case)",
     '1972',
     '1980',
     'b',
    ...
    (7,
     'easy',
     'What is the notice period under CPC Section 80?\nతెలుగు: CPC Sec.80 notice period ఎంత?',
     '1 month',
     '2 months — 2-month written notice must be given before suing Central/State Govt or public officer in official capacity',
     '3 months',
     '6 months',
     'b',
    ...
    (7,
     'medium',
     'Which State was involved in the Vidyawati case?\nతెలుగు: Vidyawati case ఏ State involved?',
     'Uttar Pradesh',
     "Rajasthan — State of Rajasthan v. Vidyawati (1962); Govt jeep driver's negligence caused accident and death; SC: non-sovereign function → Rajasthan State liable",
     'Bihar',
     'Maharashtra',
     'b',
    ...
    (7,
     'hard',
     'Which predecessor provision did Art.300 replace?\nతెలుగు: Art.300 ఏ predecessor article ని replace చేసింది?',
     'Govt of India Act 1919 Sec.32',
     'Govt of India Act 1935 Sec.176 and earlier provisions — Secretary of State in Council (British) → Dominion of India (1947) → Union of India (1950); Art.300 preserves continuity of the right to sue/be sued',
    ...
    (7,
     'medium',
     'In which year was the Chandrima Das case?\nతెలుగు: Chairman Railway Board v. Chandrima Das case ఏ year లో?',
     '1995',
     '2000 — Chairman, Railway Board v. Chandrima Das; rape by railway employees on railway premises; SC: Indian Railways (Union of India) vicariously liable; non-sovereign commercial function',
     '1985',
     '2010',
     'b',
