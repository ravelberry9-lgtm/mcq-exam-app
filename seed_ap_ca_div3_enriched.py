...
MCQ_DATA = [
    ...
    (6, 1,
     ...
     "c",
     "యోగాంధ్రలో విశాఖ 28 కి.మీ. తీరంలో 3.01 లక్షలు (3,00,105) మంది పాల్గొని గిన్నిస్ వరల్డ్ రికార్డ్ సాధించారు. లక్ష్యం 5 లక్షులుగా నిర్ణయించారు; నిజమైన రికార్డు 3,00,105 మంది (అధికారికంగా నిర్ధారించబడింది)."),
    (7, 1,
