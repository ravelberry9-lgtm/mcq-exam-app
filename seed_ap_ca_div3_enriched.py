...
MCQ_DATA = [
    ...
    # Junk MCQ blocks removed by audit 2026-05-18 (short 1-4 word questions with numeric/meaningless options,
    # cycling b->c->d answers across repeated identical question sets — all removed)
]
