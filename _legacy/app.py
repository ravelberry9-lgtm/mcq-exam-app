...
def init_db():
    ...
    try:
        ...
        if mod_count < 1 and _SEED_CH2_MODERN_LOADED:
            ...
            _seed_ch2_modern_mcqs_inner(conn, db_exec, row_to_dict, USE_POSTGRES)
    ...
    try:
        ...
        if mod3_count < 1 and _SEED_CH3_MODERN_LOADED:
            ...
            _seed_ch3_modern_mcqs_inner(conn, db_exec, row_to_dict, USE_POSTGRES)
    ...
    # ── SKIP: Constitution & Governance Comprehensive (syntax errors) ──
    ...
    # ── SKIP: Constitution & Governance Part 3 (syntax errors) ──

    # ── SKIP: Constitution & Governance Part 4 (syntax errors) ──
...
def _auto_seed_polity():
    ...
    chapters = [
        ...
        (13, 'seed_polity_ch13', 'polity_ch13'),
        (14, 'seed_polity_ch14', 'polity_ch14'),
        (15, 'seed_polity_ch15', 'polity_ch15'),
        (16, 'seed_polity_ch16', 'polity_ch16'),
        (17, 'seed_polity_ch17', 'polity_ch17'),
        (18, 'seed_polity_ch18', 'polity_ch18'),
        (19, 'seed_polity_ch19', 'polity_ch19'),
        (20, 'seed_polity_ch20', 'polity_ch20'),
        (21, 'seed_polity_ch21', 'polity_ch21'),
        (22, 'seed_polity_ch22', 'polity_ch22'),
        (23, 'seed_polity_ch23', 'polity_ch23'),
        (24, 'seed_polity_ch24', 'polity_ch24'),
        (25, 'seed_polity_ch25', 'polity_ch25'),
        (26, 'seed_polity_ch26', 'polity_ch26'),
        (27, 'seed_polity_ch27', 'polity_ch27'),
        (28, 'seed_polity_ch28', 'polity_ch28'),
        (29, 'seed_polity_ch29', 'polity_ch29'),
        (30, 'seed_polity_ch30', 'polity_ch30'),
        (31, 'seed_polity_ch31', 'polity_ch31'),
        (32, 'seed_polity_ch32', 'polity_ch32'),
        (33, 'seed_polity_ch33', 'polity_ch33'),
        (34, 'seed_polity_ch34', 'polity_ch34'),
        (35, 'seed_polity_ch35', 'polity_ch35'),
        (36, 'seed_polity_ch36', 'polity_ch36'),
        (37, 'seed_polity_ch37', 'polity_ch37'),
        (38, 'seed_polity_ch38', 'polity_ch38'),
        (39, 'seed_polity_ch39', 'polity_ch39'),
        (40, 'seed_polity_ch40', 'polity_ch40'),
        (41, 'seed_polity_ch41', 'polity_ch41'),
        (42, 'seed_polity_ch42', 'polity_ch42'),
        (43, 'seed_polity_ch43', 'polity_ch43'),
        (44, 'seed_polity_ch44', 'polity_ch44'),
        (45, 'seed_polity_ch45', 'polity_ch45'),
        (46, 'seed_polity_ch46', 'polity_ch46'),
        (47, 'seed_polity_ch47', 'polity_ch47'),
        (48, 'seed_polity_ch48', 'polity_ch48'),
        (49, 'seed_polity_ch49', 'polity_ch49'),
        (50, 'seed_polity_ch50', 'polity_ch50'),
        (51, 'seed_polity_ch51', 'polity_ch51'),
        (52, 'seed_polity_ch52', 'polity_ch52'),
        (53, 'seed_polity_ch53', 'polity_ch53'),
        (54, 'seed_polity_ch54', 'polity_ch54'),
        (55, 'seed_polity_ch55', 'polity_ch55'),
        (56, 'seed_polity_ch56', 'polity_ch56'),
        (57, 'seed_polity_ch57', 'polity_ch57'),
        (58, 'seed_polity_ch58', 'polity_ch58'),
        (59, 'seed_polity_ch59', 'polity_ch59'),
        (60, 'seed_polity_ch60', 'polity_ch60'),
        (61, 'seed_polity_ch61', 'polity_ch61'),
        (62, 'seed_polity_ch62', 'polity_ch62'),
        (63, 'seed_polity_ch63', 'polity_ch63'),
        (64, 'seed_polity_ch64', 'polity_ch64'),
        (65, 'seed_polity_ch65', 'polity_ch65'),
        (66, 'seed_polity_ch66', 'polity_ch66'),
        (67, 'seed_polity_ch67', 'polity_ch67'),
        (68, 'seed_polity_ch68', 'polity_ch68'),
        (69, 'seed_polity_ch69', 'polity_ch69'),
        (70, 'seed_polity_ch70', 'polity_ch70'),
        (71, 'seed_polity_ch71', 'polity_ch71'),
        (72, 'seed_polity_ch72', 'polity_ch72'),
        (73, 'seed_polity_ch73', 'polity_ch73'),
        (74, 'seed_polity_ch74', 'polity_ch74'),
        (75, 'seed_polity_ch75', 'polity_ch75'),
        (76, 'seed_polity_ch76', 'polity_ch76'),
        (77, 'seed_polity_ch77', 'polity_ch77'),
        (78, 'seed_polity_ch78', 'polity_ch78'),
        (79, 'seed_polity_ch79', 'polity_ch79'),
        (80, 'seed_polity_ch80', 'polity_ch80'),
        (81, 'seed_polity_ch81', 'polity_ch81'),
        (82, 'seed_polity_ch82', 'polity_ch82'),
        (83, 'seed_polity_ch83', 'polity_ch83'),
        (84, 'seed_polity_ch84', 'polity_ch84'),
        (85, 'seed_polity_ch85', 'polity_ch85'),
        (86, 'seed_polity_ch86', 'polity_ch86'),
        (87, 'seed_polity_ch87', 'polity_ch87'),
        (88, 'seed_polity_ch88', 'polity_ch88'),
...
def _auto_seed_ap_current_affairs():
    ...
    for ch_num, mod_name, fn_suffix in [
        ...
        (3, 'seed_ap_ca_div3', 'ap_ca_div3'),
        (4, 'seed_ap_ca_div4', 'ap_ca_div4'),
        (5, 'seed_ap_ca_div5', 'ap_ca_div5'),
        (6, 'seed_ap_ca_div6', 'ap_ca_div6'),
        (7, 'seed_ap_ca_div7', 'ap_ca_div7'),
        (8, 'seed_ap_ca_div8', 'ap_ca_div8'),
        (9, 'seed_ap_ca_div9', 'ap_ca_div9'),
        (10, 'seed_ap_ca_div10', 'ap_ca_div10'),
    ]:
        c = get_db()
        try:
            mod = importlib.import_module(mod_name)
...
@app.route('/api/curate-intl-260')
def curate_intl_260():
    """One-time cleanup: delete all International CA MCQs not in the 260-MCQ whitelist.
    Visit this URL once in your browser after deployment to bring Intl CA from ~1000 to 260.
    Pass ?pin=<ADMIN_PIN> for authentication.
    """
    if (request.args.get('pin') or '') != ADMIN_PIN:
        return jsonify({'error': 'unauthorized — pass ?pin=YOUR_ADMIN_PIN'}), 401
    _intl_kept_ids = (
        20002, 20003, 20005, 20006, 20013,
        21001, 21003, 21005, 21006, 21009, 21011, 21012, 21015, 21016, 21019,
        21021, 21022, 21024, 21026, 21028, 21029, 21030, 21031, 21032, 21033,
        21035, 21036, 21037,
        22001, 22002, 22003, 22004, 22008, 22009, 22010, 22013, 22015, 22017,
        23001, 23002, 23003, 23004, 23005, 23006, 23011, 23013, 23014, 23015,
        23016, 23017, 23018, 23019, 23020, 23023, 23024, 23025, 23026, 23027,
        23028, 23033, 23034, 23041, 23047, 23048, 23049, 23050, 23059, 23060,
        23061, 23062, 23063, 23064, 23065, 23066, 23068, 23069, 23070, 23073,
        23078, 23079, 23081, 23086, 23087, 23088, 23090,
        25001, 25002, 25003, 25004, 25008,
        26001, 26002, 26003, 26004, 26005, 26006, 26007, 26009, 26010,
        27001, 27002, 27003, 27005, 27006, 27007, 27009, 27010, 27011, 27013,
        27016, 27017, 27018, 27019, 27020, 27022, 27025, 27026, 27028, 27030,
        27031, 27033, 27034, 27035, 27040, 27041, 27043, 27044, 27046, 27047,
        27048, 27050, 27055, 27057, 27058, 27061, 27062, 27063, 27068, 27070,
        27071, 27073, 27074, 27076, 27077, 27078, 27080, 27081, 27082, 27083,
        27084, 27086, 27087, 27088, 27089, 27092, 27093, 27094, 27095,
        28001, 28002, 28007, 28008, 28009, 28011, 28012, 28016, 28017, 28018,
        28019, 28025, 28026, 28027, 28029, 28032, 28037, 28048, 28050, 28051,
        28053,
        29001, 29003, 29004, 29005, 29006, 29007, 29008, 29009, 29010, 29013,
        29014, 29023, 29028, 29032, 29033, 29039, 29041, 29042, 29043, 29044,
        29045, 29046, 29049, 29051, 29052, 29056, 29066, 29072, 29073, 29074,
        29077, 29078, 29083, 29084, 29086, 29087, 29094, 29095, 29096, 29097,
        29099, 29100, 29102, 29104, 29108, 29112,
        30001, 30002, 30004, 30006, 30007, 30012, 30014, 30017, 30021, 30023,
        30025, 30028, 30034, 30035, 30042, 30046, 30054, 30061, 30062, 30063,
        30064, 30065, 30069, 30076, 30077, 30081, 30082, 30084, 30085, 30089,
        30090, 30091, 30096, 30097, 30099,
    )
    conn = get_db()
    try:
        ph = '%s' if USE_POSTGRES else '?'
        ...
        conn.commit()
        rem_cur = db_exec(conn,
            "SELECT COUNT(*) FROM questions WHERE folder='AP_HC' AND topic='International_Current_Affairs'")
        remaining = _fv(rem_cur.fetchone()) if rem_cur else '?'
        conn.close()
        return jsonify({
            'status': 'ok',
            'deleted': deleted,
            'remaining_intl_ca': remaining,
            'message': f'Deleted {deleted} non-kept MCQs. {remaining} International CA MCQs remain.',
        })
    except Exception as e:
        try: conn.rollback()
        except: pass
...
def get_folder_tree():
    ...
    # AP_Current_Affairs_2026 MCQs (200 questions) are in the questions table
    # (folder='AP_HC', topic='AP_Current_Affairs_2026') and are counted above.
    # The chapter_mcqs AP_Current_Affairs content (694 questions) is accessible
    # through the chapter-quiz section independently.
...
def notes_chapter(subject, topic, chapter_id):
    ...
    notes_map = {
        ...
        ('GK', 'Indian_Polity', 13): 'Indian_Polity/Chapters/polity_ch13_notes.html',
        ('GK', 'Indian_Polity', 14): 'Indian_Polity/Chapters/polity_ch14_notes.html',
        ('GK', 'Indian_Polity', 15): 'Indian_Polity/Chapters/polity_ch15_notes.html',
        ('GK', 'Indian_Polity', 16): 'Indian_Polity/Chapters/polity_ch16_notes.html',
        ('GK', 'Indian_Polity', 17): 'Indian_Polity/Chapters/polity_ch17_notes.html',
        ('GK', 'Indian_Polity', 18): 'Indian_Polity/Chapters/polity_ch18_notes.html',
        ('GK', 'Indian_Polity', 19): 'Indian_Polity/Chapters/polity_ch19_notes.html',
        ('GK', 'Indian_Polity', 20): 'Indian_Polity/Chapters/polity_ch20_notes.html',
        ('GK', 'Indian_Polity', 21): 'Indian_Polity/Chapters/polity_ch21_notes.html',
        ('GK', 'Indian_Polity', 22): 'Indian_Polity/Chapters/polity_ch22_notes.html',
        ('GK', 'Indian_Polity', 23): 'Indian_Polity/Chapters/polity_ch23_notes.html',
        ('GK', 'Indian_Polity', 24): 'Indian_Polity/Chapters/polity_ch24_notes.html',
        ('GK', 'Indian_Polity', 25): 'Indian_Polity/Chapters/polity_ch25_notes.html',
        ('GK', 'Indian_Polity', 26): 'Indian_Polity/Chapters/polity_ch26_notes.html',
        ('GK', 'Indian_Polity', 27): 'Indian_Polity/Chapters/polity_ch27_notes.html',
        ('GK', 'Indian_Polity', 28): 'Indian_Polity/Chapters/polity_ch28_notes.html',
        ('GK', 'Indian_Polity', 29): 'Indian_Polity/Chapters/polity_ch29_notes.html',
        ('GK', 'Indian_Polity', 30): 'Indian_Polity/Chapters/polity_ch30_notes.html',
        ('GK', 'Indian_Polity', 31): 'Indian_Polity/Chapters/polity_ch31_notes.html',
        ('GK', 'Indian_Polity', 32): 'Indian_Polity/Chapters/polity_ch32_notes.html',
        ('GK', 'Indian_Polity', 33): 'Indian_Polity/Chapters/polity_ch33_notes.html',
        ('GK', 'Indian_Polity', 34): 'Indian_Polity/Chapters/polity_ch34_notes.html',
        ('GK', 'Indian_Polity', 35): 'Indian_Polity/Chapters/polity_ch35_notes.html',
        ('GK', 'Indian_Polity', 36): 'Indian_Polity/Chapters/polity_ch36_notes.html',
        ('GK', 'Indian_Polity', 37): 'Indian_Polity/Chapters/polity_ch37_notes.html',
        ('GK', 'Indian_Polity', 38): 'Indian_Polity/Chapters/polity_ch38_notes.html',
        ('GK', 'Indian_Polity', 39): 'Indian_Polity/Chapters/polity_ch39_notes.html',
        ('GK', 'Indian_Polity', 40): 'Indian_Polity/Chapters/polity_ch40_notes.html',
        ('GK', 'Indian_Polity', 41): 'Indian_Polity/Chapters/polity_ch41_notes.html',
        ('GK', 'Indian_Polity', 42): 'Indian_Polity/Chapters/polity_ch42_notes.html',
        ('GK', 'Indian_Polity', 43): 'Indian_Polity/Chapters/polity_ch43_notes.html',
        ('GK', 'Indian_Polity', 44): 'Indian_Polity/Chapters/polity_ch44_notes.html',
        ('GK', 'Indian_Polity', 45): 'Indian_Polity/Chapters/polity_ch45_notes.html',
        ('GK', 'Indian_Polity', 46): 'Indian_Polity/Chapters/polity_ch46_notes.html',
        ('GK', 'Indian_Polity', 47): 'Indian_Polity/Chapters/polity_ch47_notes.html',
        ('GK', 'Indian_Polity', 48): 'Indian_Polity/Chapters/polity_ch48_notes.html',
        ('GK', 'Indian_Polity', 49): 'Indian_Polity/Chapters/polity_ch49_notes.html',
        ('GK', 'Indian_Polity', 50): 'Indian_Polity/Chapters/polity_ch50_notes.html',
        ('GK', 'Indian_Polity', 51): 'Indian_Polity/Chapters/polity_ch51_notes.html',
        ('GK', 'Indian_Polity', 52): 'Indian_Polity/Chapters/polity_ch52_notes.html',
        ('GK', 'Indian_Polity', 53): 'Indian_Polity/Chapters/polity_ch53_notes.html',
        ('GK', 'Indian_Polity', 54): 'Indian_Polity/Chapters/polity_ch54_notes.html',
        ('GK', 'Indian_Polity', 55): 'Indian_Polity/Chapters/polity_ch55_notes.html',
        ('GK', 'Indian_Polity', 56): 'Indian_Polity/Chapters/polity_ch56_notes.html',
        ('GK', 'Indian_Polity', 57): 'Indian_Polity/Chapters/polity_ch57_notes.html',
        ('GK', 'Indian_Polity', 58): 'Indian_Polity/Chapters/polity_ch58_notes.html',
        ('GK', 'Indian_Polity', 59): 'Indian_Polity/Chapters/polity_ch59_notes.html',
        ('GK', 'Indian_Polity', 60): 'Indian_Polity/Chapters/polity_ch60_notes.html',
        ('GK', 'Indian_Polity', 61): 'Indian_Polity/Chapters/polity_ch61_notes.html',
        ('GK', 'Indian_Polity', 62): 'Indian_Polity/Chapters/polity_ch62_notes.html',
        ('GK', 'Indian_Polity', 63): 'Indian_Polity/Chapters/polity_ch63_notes.html',
        ('GK', 'Indian_Polity', 64): 'Indian_Polity/Chapters/polity_ch64_notes.html',
        ('GK', 'Indian_Polity', 65): 'Indian_Polity/Chapters/polity_ch65_notes.html',
        ('GK', 'Indian_Polity', 66): 'Indian_Polity/Chapters/polity_ch66_notes.html',
        ('GK', 'Indian_Polity', 67): 'Indian_Polity/Chapters/polity_ch67_notes.html',
        ('GK', 'Indian_Polity', 68): 'Indian_Polity/Chapters/polity_ch68_notes.html',
        ('GK', 'Indian_Polity', 69): 'Indian_Polity/Chapters/polity_ch69_notes.html',
        ('GK', 'Indian_Polity', 70): 'Indian_Polity/Chapters/polity_ch70_notes.html',
        ('GK', 'Indian_Polity', 71): 'Indian_Polity/Chapters/polity_ch71_notes.html',
        ('GK', 'Indian_Polity', 72): 'Indian_Polity/Chapters/polity_ch72_notes.html',
        ('GK', 'Indian_Polity', 73): 'Indian_Polity/Chapters/polity_ch73_notes.html',
        ('GK', 'Indian_Polity', 74): 'Indian_Polity/Chapters/polity_ch74_notes.html',
        ('GK', 'Indian_Polity', 75): 'Indian_Polity/Chapters/polity_ch75_notes.html',
        ('GK', 'Indian_Polity', 76): 'Indian_Polity/Chapters/polity_ch76_notes.html',
        ('GK', 'Indian_Polity', 77): 'Indian_Polity/Chapters/polity_ch77_notes.html',
        ('GK', 'Indian_Polity', 78): 'Indian_Polity/Chapters/polity_ch78_notes.html',
        ('GK', 'Indian_Polity', 79): 'Indian_Polity/Chapters/polity_ch79_notes.html',
        ('GK', 'Indian_Polity', 80): 'Indian_Polity/Chapters/polity_ch80_notes.html',
        ('GK', 'Indian_Polity', 81): 'Indian_Polity/Chapters/polity_ch81_notes.html',
        ('GK', 'Indian_Polity', 82): 'Indian_Polity/Chapters/polity_ch82_notes.html',
        ('GK', 'Indian_Polity', 83): 'Indian_Polity/Chapters/polity_ch83_notes.html',
        ('GK', 'Indian_Polity', 84): 'Indian_Polity/Chapters/polity_ch84_notes.html',
        ('GK', 'Indian_Polity', 85): 'Indian_Polity/Chapters/polity_ch85_notes.html',
        ('GK', 'Indian_Polity', 86): 'Indian_Polity/Chapters/polity_ch86_notes.html',
        ('GK', 'Indian_Polity', 87): 'Indian_Polity/Chapters/polity_ch87_notes.html',
        ('GK', 'Indian_Polity', 88): 'Indian_Polity/Chapters/polity_ch88_notes.html',
        ('GK', 'Indian_Polity', 89): 'Indian_Polity/Chapters/polity_ch89_notes.html',
        ('GK', 'Indian_Polity', 90): 'Indian_Polity/Chapters/polity_ch90_notes.html',
    }
...
# ─────────────────────────────────────────────────────────────────────────────
# MODERN CH2 — Establishment of British Empire (seed_ch2_modern.py)
# ─────────────────────────────────────────────────────────────────────────────

try:
    from seed_ch2_modern import (
        _seed_ch2_modern_notes_inner,
        _seed_ch2_modern_mcqs_inner,
    )
    _SEED_CH2_MODERN_LOADED = True
except Exception as _e:
    print(f"[WARN] seed_ch2_modern.py not loaded: {_e}")
    _SEED_CH2_MODERN_LOADED = False

@app.route('/api/notes/seed_modern_ch2', methods=['POST'])
def notes_seed_modern_ch2():
    if not _SEED_CH2_MODERN_LOADED:
        return jsonify({'success': False, 'error': 'seed_ch2_modern.py not found'}), 500
    force = request.args.get('force', '0') == '1'
    conn = get_db()
    try:
        result = _seed_ch2_modern_notes_inner(conn, db_exec, row_to_dict, USE_POSTGRES, force=force)
        return jsonify(result)
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)}), 500
    finally:
...
@app.route('/api/mcq/seed_modern_ch2', methods=['POST'])
def seed_modern_ch2_mcqs():
    if not _SEED_CH2_MODERN_LOADED:
        return jsonify({'success': False, 'error': 'seed_ch2_modern.py not found'}), 500
    conn = get_db()
    try:
        _seed_ch2_modern_notes_inner(conn, db_exec, row_to_dict, USE_POSTGRES, force=False)
        result = _seed_ch2_modern_mcqs_inner(conn, db_exec, row_to_dict, USE_POSTGRES)
        return jsonify(result)
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)}), 500
    finally:
...
# ─────────────────────────────────────────────────────────────────────────────
# MODERN CH3 — British Sovereignty (seed_ch3_modern.py)
# ─────────────────────────────────────────────────────────────────────────────

try:
    from seed_ch3_modern import (
        _seed_ch3_modern_notes_inner,
        _seed_ch3_modern_mcqs_inner,
    )
    _SEED_CH3_MODERN_LOADED = True
except Exception as _e:
    print(f"[WARN] seed_ch3_modern.py not loaded: {_e}")
    _SEED_CH3_MODERN_LOADED = False

@app.route('/api/notes/seed_modern_ch3', methods=['POST'])
def notes_seed_modern_ch3():
    if not _SEED_CH3_MODERN_LOADED:
        return jsonify({'success': False, 'error': 'seed_ch3_modern.py not found'}), 500
    force = request.args.get('force', '0') == '1'
    conn = get_db()
    try:
        result = _seed_ch3_modern_notes_inner(conn, db_exec, row_to_dict, USE_POSTGRES, force=force)
        return jsonify(result)
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)}), 500
    finally:
...
@app.route('/api/mcq/seed_modern_ch3', methods=['POST'])
def seed_modern_ch3_mcqs():
    if not _SEED_CH3_MODERN_LOADED:
        return jsonify({'success': False, 'error': 'seed_ch3_modern.py not found'}), 500
    conn = get_db()
    try:
        _seed_ch3_modern_notes_inner(conn, db_exec, row_to_dict, USE_POSTGRES, force=False)
        result = _seed_ch3_modern_mcqs_inner(conn, db_exec, row_to_dict, USE_POSTGRES)
        return jsonify(result)
    except Exception as e:
        return jsonify({'success': False, 'error': str(e)}), 500
    finally:
...
def search_proxy():
    ...
    # ── Clean query: strip question-format words, append correct answer ──
    clean = re.sub(
        ...
        r'the|a|an|of|in|on|at|by|for)\b',
        ' ', q, flags=re.IGNORECASE)
    clean = re.sub(r'\s+', ' ', clean).strip()
    search_q = (clean[:70] + ' ' + a[:40]).strip() or q[:80]

    CSS = ('<style>*{box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'
           'sans-serif;font-size:13.5px;line-height:1.75;color:#1a1a2e;padding:14px;margin:0;background:#fff}'
           'h3{font-size:14px;font-weight:700;color:#1a237e;margin:0 0 8px;line-height:1.4}'
           'p{margin:0 0 8px;color:#333}'
           '.result{border-bottom:1px solid #eee;padding-bottom:10px;margin-bottom:10px}'
           '.result:last-of-type{border:none}'
           '.url{font-size:11px;color:#888;margin-bottom:3px}'
           '.tag{font-size:10px;color:#888;letter-spacing:.5px;text-transform:uppercase;margin-bottom:10px}'
           '.links{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px}'
           'a.btn{display:inline-block;font-size:12px;color:#1a237e;border:1.5px solid #c5cae9;'
           'border-radius:50px;padding:5px 13px;text-decoration:none;font-weight:600}'
           'a.pplx{background:#1a237e;color:#fff;border-color:#1a237e}</style>')

    pplx_url = 'https://www.perplexity.ai/search?q=' + quote(q[:120])

    def results_page(source, items):
        """items = list of {title, snippet, url}"""
        rows = ''
        for it in items[:4]:
            rows += (f'<div class="result">'
                     f'<div class="url">{it.get("url","")[:60]}</div>'
                     f'<h3>{it.get("title","")}</h3>'
                     f'<p>{it.get("snippet","")}</p>'
                     f'</div>')
        return (f'<!DOCTYPE html><html><head><meta charset="UTF-8">{CSS}</head><body>'
                f'<div class="tag">{source}</div>{rows}'
                f'<div class="links">'
                f'<a class="btn pplx" href="{pplx_url}" target="_blank">🔍 Perplexity ↗</a>'
                f'</div></body></html>')

    def fallback_page():
        return (f'<!DOCTYPE html><html><head><meta charset="UTF-8">{CSS}</head>'
                f'<body style="text-align:center;padding-top:50px">'
                f'<div style="font-size:36px;margin-bottom:12px">🔍</div>'
                f'<p style="color:#666;margin-bottom:16px">No results found.</p>'
                f'<a class="btn pplx" href="{pplx_url}" target="_blank">Open in Perplexity ↗</a>'
                f'</body></html>')

    from flask import Response as FR
    HDR = {'User-Agent': 'Mozilla/5.0 (compatible; MCQApp/1.0; +educational)'}

    # ── 1. Brave Search API (set BRAVE_API_KEY in Railway for best results) ──
    brave_key = os.environ.get('BRAVE_API_KEY', '')
    if brave_key:
        try:
            r = req.get('https://api.search.brave.com/res/v1/web/search',
                params={'q': search_q, 'count': 4, 'search_lang': 'en'},
                headers={'Accept': 'application/json', 'X-Subscription-Token': brave_key},
                timeout=7)
            items = [{'title': x.get('title',''), 'snippet': x.get('description',''),
                      'url': x.get('url','')} for x in r.json().get('web',{}).get('results',[])]
            if items:
                return FR(results_page('🔎 Brave Search', items), 200, content_type='text/html; charset=utf-8')
        except Exception:
            pass
