...
MCQ_DATA = [
    (0, 1,
     ...
     "₹2 లక్షల కోట్లుకు పైగా", "₹1 లక్ష కోట్లు", "₹50,000 కోట్లు", "₹3 లక్షల కోట్లు",
     "a",
    ...
    (5, 1,
     ...
     "a",
     "అమరావతి క్వాంటం వ్యాలీ ఆలోచన ఆగస్టు 2025లో మొదలైంది. ఎనిమిది నెలల్లో ఏప్రిల్ 14, 2026న (World Quantum Day + అంబేద్కర్ జయంతి) IBM Quantum System Two (156-qubit Heron R2) అంకితం చేయబడింది."),
    (5, 1,
    ...
    (5, 2,
     ...
     "a",
     "Amaravati Quantum Valley లో హార్డ్‌వేర్ సరఫరాదారుడు = IBM (Quantum System Two with 156-qubit Heron R2 processor, 156 superconducting qubits). ముఖ్య IT భాగస్వామి = TCS. ఇతర భాగస్వాములు: L&T, CDAC, CDOT, IITs, 50+ సంస్థలు. Foundation Stone: Feb 7, 2026 (CM చంద్రబాబు + కేంద్ర మంత్రి జితేంద్ర సింగ్). అంకితం: ఏప్రిల్ 14, 2026."),
    (5, 3,
     ...
     "a",
     "ఆగస్టు 2025లో ఆలోచన మొదలై ఏప్రిల్ 14, 2026న (8 నెలలు) అంకితం — భారత్‌లో అరుదైన వేగవంతమైన టెక్ ప్రాజెక్ట్ డెలివరీ. రెండు క్వాంటం రిఫరెన్స్ ఫెసిలిటీస్ తూర్పు AP లో సాధించిన మైలుకల్ల."),
    (6, 1,
    ...
    (7, 1,
     ...
     "b",
     "అన్నదాత సుఖీభవ మొదటి విడత మొత్తం ₹7,000. ఏడాదికి మొత్తం ₹20,000 (రాష్ట్రం ₹14,000 + PM KISAN ₹6,000)."),
    (7, 1,
