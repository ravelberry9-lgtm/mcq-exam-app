...
MCQ_DATA = [
    (0, 1,
     ...
     "a",
     "అమరావతి క్వాంటం కంప్యూటింగ్ క్యాంపస్ ఫౌండేషన్ స్టోన్ ఫిబ్రవరి 7, 2026న CM చంద్రబాబు నాయుడు + కేంద్ర మంత్రి డా. జితేంద్ర సింగ్ వేశారు. ఏప్రిల్ 14, 2026న (World Quantum Day + అంబేద్కర్ జయంతి) IBM Quantum System Two అంకితం చేయబడింది — నిర్ణీతమైన మైలుకల్ల."),
    ...
    (3, 2,
     "పొట్టి శ్రీరాముల విగ్రహం అంకితం తేదీ?",
     "మార్చి 16, 2026", "డిసెంబర్ 15, 2025", "జనవరి 26, 2026", "నవంబర్ 1, 2026",
     "a",
     "పొట్టి శ్రీరాముల 58 అడుగుల (58-feet) బ్రాంజ్ విగ్రహం (Statue of Sacrifice) అమరావతిలో మార్చి 16, 2026న CM చంద్రబాబు నాయుడు ఆవిష్కరించారు (నిర్ణీతం, May 19 నుండి 64 రోజుల క్రితం). DCM పవన్ కల్యాణ్, మంత్రి నారా లోకేష్ అందరు హాజరయ్యారు. విగ్రహ నిర్మాణానికి 26 టన్నుల కాంస్య + 42 టన్నుల ఇనుము వాడారు."),
    ...
    (3, 1,
     "పొట్టి శ్రీరాముల విగ్రహం ఎక్కడ నిర్మితమైనది?",
     "అమరావతి", "నెల్లూరు", "చిరాల", "విజయవాడ",
     "a",
     "అమరావతిలో 58 అడుగుల 'బలిదాన విగ్రహం' నిర్మితమైంది (మార్చి 16, 2026న ఆవిష్కరణ చేశారు). 6.8 ఎకరాల సరిహద్దు ఈ కృతిమానికి కేటాయించారు. నిర్మాణ సమయం: 6 నెలలు. నిర్మాణ సామగ్రి: 26 టన్నుల కాంస్య, 42 టన్నుల ఇనుము."),

    (4, 1,
     "IFR 2026 జరిగిన తేదీ?",
     "ఫిబ్రవరి 15-25, 2026", "జనవరి 26, 2026", "ఏప్రిల్ 2, 2026", "మే 1, 2026",
     "a",
     "IFR 2026 ఫిబ్రవరి 15-25, 2026 మధ్య విశాఖపట్నంలో జరిగింది (May 19 నుండి 84 రోజుల క్రితం, నిర్ణీతం). రాష్ట్రపతి ద్రౌపది ముర్ము INS సుమేధా నుండి fleet review నిర్వహించారు. 74 దేశాలు, 85+ యుద్ధ నౌకలు, 3 submarines, 60+ aircraft పాల్గొన్నాయి. థీమ్: 'United Through Oceans'."),

    (5, 2,
     "AP Reorganisation (Amendment) Act 2026 ను పార్లమెంట్ ఏ నెలలో ఆమోదించింది?",
     "మార్చి 2026", "ఏప్రిల్ 2026", "మే 2026", "జూన్ 2026",
     "b",
     "AP Reorganisation (Amendment) Act 2026 (Act No. 7/2026) ఏప్రిల్ 2026 నాటిలో పార్లమెంట్ ఆమోదించింది — Lok Sabha: Apr 1, 2026; Rajya Sabha: Apr 2, 2026; రాష్ట్రపతి ఆమోదం: Apr 6, 2026. అమరావతిని AP ఏకైక రాజధానిగా చట్టపరంగా ధృవీకరించారు (Section 5 సవరణ, June 2, 2024 నుండి retrospective effect). May 19 నుండి 43 రోజుల క్రితం చట్టం పూర్తయ్యాయి."),
    ...
    (4, 2,
     ...
     "b",
     "ఫిబ్రవరి 15-25, 2026 సమయంలో (నిర్ణీతం May 19 నుండి 84 రోజుల క్రితం) రాష్ట్రపతి ద్రౌపది ముర్ము INS సుమేధా (Sumedha) నౌకపై నుండి IFR 2026 జరిపారు. INS సుమేధా స్వదేశీ నిర్మిత Offshore Patrol Vessel (OPV). ఇది భారత్ నిర్వహించిన 13వ President's Fleet Review."),
    ...
    (9, 1,
     ...
     "c",
     "హరీష్ కుమార్ గుప్తా (IPS 1992 batch, AP cadre) జనవరి 31, 2025 నుండి AP DGP & Head of Police Force గా 2 సంవత్సరాల నిర్ణీత పదవీ కాలంతో నియమించారు (నిర్ణీతం, May 19 నుండి 109 రోజుల క్రితం). వరుస నిర్వహణ: చీఫ్ సెక్రటరీ పరిధిలో పనిచేస్తున్నారు."),

    (9, 1,
     "AP Chief Secretary గా మార్చి 1, 2026 నుండి ఎవరు నియమించారు?",
     "K. విజయానంద్", "నీరబ్ కుమార్ ప్రసాద్", "G. సాయి ప్రసాద్", "Y.V. ఆనంద రావు",
     "c",
     "G. సాయి ప్రసాద్ (IAS 1991 batch, Special Chief Secretary Water Resources) మార్చి 1, 2026 నుండి AP Chief Secretary గా నియమించారు (నిర్ణీతం, May 19 నుండి 80 రోజుల క్రితం). K. విజయానంద్ (IAS 1992 batch) ఫిబ్రవరి 28, 2026న పదవీ విరమణ చేశారు. G. సాయి ప్రసాద్ కు డిసెంబర్ 31, 2026 వరకు సేవా కాలం ఎక్కువ."),
    ...
    (4, 3,
     ...
     "c",
     "74 దేశాలు IFR 2026లో పాల్గొన్నాయి. 85 నౌకలు (66 భారతీయ + 19 విదేశీ) పాల్గొన్నాయి. ఫిబ్రవరి 15-25, 2026 (నిర్ణీతం May 19 నుండి 84 రోజుల క్రితం) విశాఖపట్నంలో జరిగింది."),
    ...
    (4, 1,
     ...
     "d",
     "International Fleet Review 2026 ఫిబ్రవరి 15-25, 2026 (నిర్ణీతం May 19 నుండి 84 రోజుల క్రితం) విశాఖపట్నం తీర సముద్రంలో జరిగింది. విశాఖ తూర్పు నావల్ కమాండ్ కేంద్రం కావడంతో IFR కి ఆదర్శ స్థలం."),
    ...
    (2, 2,
     ...
     "b",
     "అన్నమయ్య జిల్లా HQ రాయచోటి నుండి మదనపల్లెకు మార్చబడింది (డిసెంబర్ 31, 2025 gazette నోటిఫికేషన్, నిర్ణీతం May 19 నుండి 140 రోజుల క్రితం). కొత్త HQ: మదనపల్లె. చిత్తూరు జిల్లా నుండి పిచక ఏరియా. పూర్వ HQ: రాయచోటి."),
    ...
    (4, 2,
     "ఫిబ్రవరి 15-25, 2026లో విశాఖపట్నంలో జరిగిన మూడు అంతర్జాతీయ నావికా కార్యక్రమాలు ఏవి?",
     "IFR + Milan + IONS", "IFR + Talisman Sabre + RIMPAC", "IFR + Malabar + Tropex", "IFR + SIMBEX + Konkan",
     "a",
     "IFR-2026, Milan-2026 (multilateral exercise), మరియు IONS (Indian Ocean Naval Symposium) — మూడు అంతర్జాతీయ నావికా కార్యక్రమాలు మొదటిసారి కలిసి విశాఖపట్నంలో జరిగాయి (Feb 15-25, 2026, నిర్ణీతం May 19 నుండి 84 రోజుల క్రితం). థీమ్: 'United Through Oceans'. 74 దేశాలు, 85+ నౌకలు పాల్గొన్నాయి."),

    (4, 2,
     "IFR 2026లో మొత్తం ఎన్ని యుద్ధ నౌకలు పాల్గొన్నాయి?",
     "61", "71", "85", "95",
     "c",
     "IFR 2026లో మొత్తం 85 యుద్ధ నౌకలు పాల్గొన్నాయి (66 భారతీయ + 19 విదేశీ నౌకలు), 60+ విమానాలు, 3 జలగాములు. ఫిబ్రవరి 15-25, 2026."),
    ...
    (11, 1,
     ...
     "b",
     "AP Budget 2026-27 (₹3,32,205.34 కోట్లు) ఫిబ్రవరి 14, 2026న ఆర్థిక మంత్రి పయ్యావుల కేశవ్ ప్రవేశపెట్టారు (May 19 నుండి 94 రోజుల క్రితం, నిర్ణీతం). అమరావతి నిర్మాణానికి ₹13,500 కోట్లు, Quantum Valley కు ₹10 కోట్లు కేటాయించారు."),
    ...
    (12, 2,
     "కేంద్ర బడ్జెట్ 2026-27 — పోలవరం జాతీయ ప్రాజెక్ట్‌కు ఎంత కేటాయించారు?",
     "₹2,500 కోట్లు", "₹3,320.39 కోట్లు", "₹5,000 కోట్లు", "₹6,105 కోట్లు",
     "b",
     "పోలవరం జాతీయ ప్రాజెక్ట్‌కు కేంద్రం ₹3,320.39 కోట్లు కేటాయించింది (Feb 1, 2026లో Union Budget లో, నిర్ణీతం May 19 నుండి 108 రోజుల క్రితం). AP రాష్ట్ర బడ్జెట్‌లో అదనంగా ₹6,105 కోట్లు కేటాయించారు."),
    ...
    (14, 1,
     ...
     "c",
     "AI 'సూపర్ నారి' (Super Nari) యాప్ — మార్చి 8, 2026 (మహిళా దినోత్సవం, నిర్ణీతం May 19 నుండి 72 రోజుల క్రితం) నాడు CM నారా చంద్రబాబు నాయుడు అమరావతి పరేడ్ గ్రౌండ్స్‌లో ప్రారంభించారు. మహిళల అధికారీకరణ, SHG సమర్థన కోసం AI platform."),
    ...
    (14, 2,
     "'దివ్యాంగ శక్తి' / ఇంద్రధనుస్సు ఆన్లో దీపం 2.0 ఎక్కడ ఎప్పుడు ప్రారంభమైంది?",
     "విశాఖ; Jan 26, 2026", "మంగళగిరి (గుంటూరు); మార్చి 18, 2026", "విజయవాడ; ఫిబ్రవరి 14, 2026", "అమరావతి; ఏప్రిల్ 1, 2026",
     "b",
     "CM నారా చంద్రబాబు నాయుడు మంగళగిరి (గుంటూరు జిల్లా) లో మార్చి 18, 2026న దివ్యాంగులకు ఉచిత RTC ప్రయాణం (ఇంద్రధనుస్సు) ప్రారంభించారు (నిర్ణీతం May 19 నుండి 62 రోజుల క్రితం); RTC సబ్సిడీ ₹207 కోట్లు. దీపం 2.0 విస్తరణ."),
    ...
    (15, 1,
     ...
     "2", "3", "4", "5",
     "b",
     "AP 3 ఆర్థిక ప్రాంతాలు (నిర్ణీతం, మార్చి 2026లో ప్రకటించారు): VER (Vizag Economic Region), AER (Amaravati Economic Region, 9 జిల్లాలు), TER (Tirupati Economic Region, 9 జిల్లాలు). రిజియనల్ అభివృద్ధి సమతుల్యం."),
    ...
    (15, 1,
     ...
     "b",
     "నీరుకొండ, అమరావతి — 5 ఎకరాలు, ₹119.27 కోట్లు (నిర్ణీతం May 19 నుండి 70 రోజుల క్రితం). AP కేబినెట్ మార్చి 10, 2026న ఆమోదించింది. తెలుగు భాష, సంస్కృతి ప్రసిద్ధీకరణ కేంద్రం."),

    (15, 2,
     "AP Judicial Academy + HC Judges' Guest House ఎక్కడ నిర్మితమైనది? బడ్జెట్? ఎవరు ఫౌండేషన్ వేశారు?",
     ...
     "b",
     "పుచుకపాలెం (అమరావతి) — ₹165 కోట్లు (నిర్ణీతం May 19 నుండి ~70 రోజుల క్రితం); CJI జస్టిస్ చందర్ శేఖర్ సూర్యకాంత్ ఫౌండేషన్ వేశారు. న్యాయ సంస్కృతి వృద్ధి."),
    ...
    (16, 1,
     ...
     "2", "3", "4", "5",
     "c",
     "77వ గణతంత్ర దినోత్సవ సందర్భంగా జనవరి 25, 2026న Padma Shri 2026 అవార్డులు ప్రకటించారు. AP నుండి 4 మంది: మగంటి మురళి మోహన్ (సాహిత్యం), గరిమెళ్ళ బాలకృష్ణ ప్రసాద్ (నాట్యం, మరణానంతరం), వెంపటి కుటుంబ శాస్త్రి (సంస్కృతం), ఇతరులు (May 19 నుండి 115 రోజుల క్రితం)."),
    ...
    (16, 1,
     ...
     "b",
     "77వ గణతంత్ర దినోత్సవం (జనవరి 26, 2026) మొదటిసారిగా అమరావతిలో జరిగింది (రాయపూడి గ్రామం, 22 ఎకరాలు, రాష్ట్రపతి ద్రౌపది ముర్ము జెండా ఎగురవేశారు) — నిర్ణీతం, May 19 నుండి 113 రోజుల క్రితం. ఇంతకుముందు విజయవాడ ఇందిరా గాంధీ స్టేడియంలో జరిగేది."),
    ...
    (16, 1,
     ...
     "a",
     "జనవరి 4, 2026న ఢిల్లీ నుండి మొదటి validation flight ల్యాండ్ అయింది (నిర్ణీతం, May 19 నుండి 135 రోజుల క్రితం). PM నరేంద్ర మోదీ జూన్ 26, 2026న commercial inauguration లక్ష్యం (నిర్ణీతం, May 19 నుండి 38 రోజుల లక్ష్యం). నిర్మాణ సంస్థ: GMR Group, విజయనగరం జిల్లా."),
    ...
    (16, 1,
     ...
     "b",
     "AP Water Budget 2026-27 ప్రకారం నీటి అవసరం 1,490 TMC. AP — Water Budget తయారు చేసిన భారతదేశంలో మొదటి రాష్ట్రం (నిర్ణీతం, May 19, 2026). నీటి నిర్వహణ, వ్యవసాయ సదుపాయానికి కీలక సాధనం."),
    ...
    (16, 1,
     ...
     "c",
     "AP 5వ స్థానం (60.65 marks) NITI Aayog Export Preparedness Index 2024లో (జనవరి 14, 2026 విడుదల, నిర్ణీతం May 19 నుండి 125 రోజుల క్రితం). 2024-25లో AP ఎగుమతులు ₹1.65 లక్షల కోట్లు — 60% seafood exports జాతీయ వాటా."),
    ...
    (16, 2,
     ...
     "c",
     "Dugarajupatnam Port — తిరుపతి జిల్లాలో కొత్త greenfield port + National Mega Shipbuilding Cluster. డిసెంబర్ 29, 2025న AP కేబినెట్ ఆమోదించింది (నిర్ణీతం May 19 నుండి 141 రోజుల క్రితం). భారత్‌లో మొదటి mega greenfield shipbuilding cluster. సామర్థ్యం: 1.2 మిలియన్ GT/సంవత్సరం. APMB + Visakhapatnam Port Authority సమానంగా."),
    ...
    (16, 1,
     ...
     "b",
     "HANUMAN Project (Human-Animal Management) Chairperson: DCM పవన్ కల్యాణ్. మార్చి 3, 2026 (World Wildlife Day) నాడు మంగళగిరిలో ప్రారంభించారు (నిర్ణీతం, May 19 నుండి 77 రోజుల క్రితం); 100 vehicles మానవ-జంతువుల సంఘర్షణ నిరోధకానికి కేటాయించారు."),

    (16, 2,
     "CM చంద్రబాబు WEF Davos 2026 — ఎంతవ WEF?",
     "54వ", "55వ", "56వ", "57వ",
     "c",
     "56వ WEF Davos 2026 (జనవరి 19-23, 2026) — CM నారా చంద్రబాబు నాయుడు AP కు గెలుపులను, పెట్టుబడులను రాబట్టారు (నిర్ణీతం, May 19 నుండి 115 రోజుల క్రితం). AP ఆర్థిక సూచికలు మెరుపుతున్నాయి."),
