...
questions = [
    ...
    # ── Excretory System ──
    (
        "The structural and functional unit of kidney is\nтెлугు: మూత్రపిండం యొక్క నిర్మాణ మరియు క్రియాత్మక యూనిట్ ఏది?",
    ...
    (
        "Which of these is NOT a function of the kidney?\nтెлугу: కింది వాటిలో మూత్రపిండం యొక్క విధి కానిది ఏది?",
    ...
    (
        "The yellow colour of urine is due to\nтెлугు: మూత్రంలో పసుపు రంగుకు కారణం ఏది?",
    ...
    (
        "Excessive sugar in urine is called\nтెлугు: మూత్రంలో అధిక చక్కెర ఉండడాన్ని ఏమంటారు?",
    ...
    # ── Respiratory System ──
    (
        "The exchange of gases in lungs takes place in\nтెлугు: ఊపిరితిత్తులలో వాయువుల మార్పిడి ఎక్కడ జరుగుతుంది?",
    ...
    (
        "The breathing rate of a normal adult at rest is\nтెлугు: సాధారణ వయోజనుడి (విశ్రాంతిలో) శ్వాస రేటు ఎంత?",
    ...
    (
        "The vital capacity of human lungs is approximately\nтెлугు: మానవ ఊపిరితిత్తుల యొక్క vital capacity సుమారు ఎంత?",
    ...
    (
        "Hemoglobin combines with which gas to form carboxyhemoglobin?\nтెлугు: కార్బోక్సీహిమోగ్లోబిన్ ఏర్పడటానికి హిమోగ్లోబిన్ ఏ వాయువుతో కలుస్తుంది?",
    ...
    (
        "Reflex actions are controlled by\nтెлугు: ప్రతిచర్యలు (reflex actions) దేని ద్వారా నియంత్రించబడతాయి?",
    ...
    (
        "The functional unit of the nervous system is\nтెлугు: నాడీ వ్యవస్థ యొక్క క్రియాత్మక యూనిట్ ఏది?",
    ...
    (
        "Which part of the brain controls balance and posture?\nтెлугు: మెదడులో సమతుల్యత (balance) మరియు భంగిమ (posture) నియంత్రించే భాగం ఏది?",
    ...
    (
        "The 'master gland' of the human body is\nтెлугు: మానవ శరీరంలో 'మాస్టర్ గ్రంథి' ఏది?",
    ...
    (
        "Thyroxine hormone is secreted by\nтెлугу: థైరాక్సిన్ హార్మోన్ ఏ గ్రంథి స్రవిస్తుంది?",
    ...
    (
        "Goitre is caused by deficiency of\nтెлугు: గాయిటర్ ఏ లోపం వల్ల వస్తుంది?",
    ...
    (
        "Adrenaline (epinephrine) is secreted by\nтెлугу: అడ్రినలిన్ (ఎపినెఫ్రిన్) ఏ భాగం స్రవిస్తుంది?",
    ...
    # ── Sensory Organs ──
    (
        "The ear has how many parts?\nтెлугు: చెవికి ఎన్ని భాగాలు ఉన్నాయి?",
        "2 / 2", "3 / 3", "4 / 4", "5 / 5",
        "B", "E",
    ...
    (
        "Balance is maintained by which part of the ear?\nтెлугు: చెవిలో సమతుల్యత నియంత్రణ ఏ భాగం చేస్తుంది?",
    ...
    (
        "The five basic tastes are\nтెлугు: ఐదు ప్రాథమిక రుచులు ఏవి?",
    ...
    (
        "Color blindness is the inability to distinguish\nтెлугу: వర్ణాంధత్వం (color blindness) ఏ రంగులను గుర్తించలేకపోవడం?",
    ...
    (
        "Scurvy is caused by deficiency of\nтెлугు: స్కర్వీ ఏ విటమిన్ లోపం వల్ల వస్తుంది?",
    ...
    (
        "Beriberi disease is caused by deficiency of\nтెлугу: బెరిబెరి వ్యాధి ఏ విటమిన్ లోపం వల్ల వస్తుంది?",
    ...
    (
        "Anemia is generally caused by deficiency of\nтెлугу: రక్తహీనత (anemia) సాధారణంగా ఏ లోపం వల్ల?",
    ...
    (
        "Vitamin K is mainly required for\nтెлугу: విటమిన్ K ప్రధానంగా దేనికి అవసరం?",
    ...
    # ── Bones and Muscles ──
    (
        "Total number of bones in the adult human body is\nтెлугు: వయోజన మానవ శరీరంలో మొత్తం ఎముకల సంఖ్య ఎంత?",
    ...
    (
        "The longest bone in the human body is\nтెлугు: మానవ శరీరంలో అతిపెద్ద ఎముక ఏది?",
    ...
    # ── Reproductive System ──
    (
        "The site of fertilization in human female is\nтెлугу: మానవ స్త్రీలో ఫలదీకరణ (fertilization) జరిగే స్థలం ఏది?",
    ...
    (
        "The normal duration of human pregnancy is\nтెлугు: మానవ గర్భధారణ సాధారణ కాలవ్యవధి ఎంత?",
    ...
    (
        "The sex chromosomes in human male are\nтెлугу: మానవ పురుషుడిలో లింగ క్రోమోజోములు ఏవి?",
    ...
    (
        "Number of chambers in human heart is\nтెлугు: మానవ హృదయంలో ఎన్ని గదులు ఉన్నాయి?",
        "2 / 2", "3 / 3", "4 / 4", "5 / 5",
        "C", "E",
    ...
    (
        "The normal heart rate of an adult at rest is\nтెлугу: విశ్రాంతిలో వయోజనుడి సాధారణ హృదయ స్పందన ఎంత?",
    ...
    (
        "Blood pressure is normally measured in which units?\nтెлугу: రక్తపోటును సాధారణంగా ఏ ప్రమాణాలలో కొలుస్తారు?",
