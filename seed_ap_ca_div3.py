...
- Re-verified all 44 MCQs against canonical facts; no stale-fact issues found.
- Div3 scope is bounded to Jan-Aug 2025 (post-Apr 2026 events live in Div4).
- Added 5 gap-fill MCQs at end covering under-tested facts: Pudimadaka acreage,
  RINL BF restart sequence, Polavaram new-district HQ, Yogandhra RK→Bheemli
  endpoints, Stree Shakti APSRTC zones.
"""
...
MCQ_DATA = [
    ...
    # ─── 2026-05-19 FRESHNESS GAP-FILL (5 MCQs) ───
    (0, 2,
     "NTPC పుట్టి హైడ్రోజన్ హబ్ పుడిమడకలో ఎన్ని ఎకరాల్లో నెలకొల్పుతున్నారు?",
     "500 ఎకరాలు", "800 ఎకరాలు", "1,200 ఎకరాలు", "2,000 ఎకరాలు",
     "c",
     "NTPC గ్రీన్ హైడ్రోజన్ హబ్ పుడిమడక (విశాఖ జిల్లా) లో 1,200 ఎకరాల్లో నెలకొల్పుతున్నారు. 2032 నాటికి 1.2 MMTPA గ్రీన్ హైడ్రోజన్ ఉత్పత్తి లక్ష్యం, 20+ GW renewable capacity."),

    (3, 2,
     "RINL లో 2 Blast Furnaces పునరారంభం ఎప్పుడు, 3 BFs పూర్తి స్థాయి ఎప్పుడు?",
     "2 BFs జనవరి 2025, 3 BFs జులై 2025", "2 BFs 2025 ప్రారంభం, 3 BFs ఆగస్టు 2025", "2 BFs ఏప్రిల్ 2025, 3 BFs డిసెంబర్ 2025", "2 BFs ఫిబ్రవరి 2025, 3 BFs జూన్ 2025",
     "b",
     "RINL లో 2 Blast Furnaces 2025 ప్రారంభంలో పునరారంభం; 3 Blast Furnaces ఆగస్టు 2025 కల్లా పూర్తి స్థాయి ఉత్పత్తి మొదలుపెట్టాయి. ₹11,440 కోట్ల కేంద్ర పునరుద్ధరణ ప్యాకేజీ."),

    (4, 3,
     "పోలవరం ప్రాజెక్ట్ R&R + భూసేకరణ fast-track కోసం AP లో ఏ కొత్త జిల్లా ఏర్పాటు చేశారు? HQ ఏది?",
     "పోలవరం జిల్లా; HQ రాజమండ్రి", "అల్లూరి సీతారామరాజు; HQ రంపచోడవరం", "తూర్పు గోదావరి; HQ కాకినాడ", "ఎలూరు; HQ ఎలూరు పట్టణం",
     "b",
     "డిసెంబర్ 31, 2025న కేబినెట్ నిర్ణయంతో అల్లూరి సీతారామరాజు జిల్లా (HQ రంపచోడవరం) ఏర్పాటు — పోలవరం R&R, భూసేకరణకు ప్రత్యేక జిల్లా. (గమనిక: 2026 జనవరి 1 నుండి 28 జిల్లాల ఏర్పాటులో పోలవరం జిల్లా అదే HQ తో ప్రకటించబడింది.)"),

    (6, 2,
     "యోగాంధ్రలో 28 కి.మీ. యోగా stretch ఏ రెండు ప్రాంతాల మధ్య నిర్వహించారు?",
     "RK Beach నుండి భీముణిపట్నం", "విశాఖపట్నం పోర్ట్ నుండి అరకు", "కైలాసగిరి నుండి యారాడ", "డాల్ఫిన్ నోస్ నుండి భీముణిపట్నం",
     "a",
     "యోగాంధ్రలో 28 కి.మీ. తీర corridor RK Beach (విశాఖ) నుండి భీముణిపట్నం వరకు. 3,00,105 మంది పాల్గొని Largest Open-Air Yoga Gathering గిన్నిస్ రికార్డు సాధించారు."),

    (7, 3,
     "ఆగస్టు 15, 2025న 'స్త్రీ శక్తి' అధికారిక పేరు పెట్టేటప్పుడు అదే రోజు ఎన్ని APSRTC జోన్‌లకు పథకం విస్తరించారు?",
     "3 జోన్‌లు", "4 జోన్‌లు", "5 జోన్‌లు", "7 జోన్‌లు",
     "c",
     "ఆగస్టు 15, 2025న 1వ వార్షికోత్సవం రోజున 'స్త్రీ శక్తి' అధికారిక పేరు పెట్టడంతో పాటు అన్ని 5 APSRTC జోన్‌లకు పథకం విస్తరించారు. (ఉచిత బస్సు ప్రయాణం ఆగస్టు 15, 2024 ప్రారంభం; 'స్త్రీ శక్తి' అధికారిక బ్రాండింగ్ ఏడాది తరువాత.)"),
]
