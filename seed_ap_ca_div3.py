...
SECTIONS_JSON = [
    ...
    },
    {
        ...
        "sub": "Amaravati Quantum Valley — Idea Aug 2025, Computers April 2026 (Div 4)",
    ...
    },
    {
        ...
        "sub": "Yogandhra June 21 (Guinness) + INS Arnala First ASW Corvette",
...
MCQ_DATA = [
    ...
    # ==================== Section 0: PM Modi Jan 8, 2025 Vizag Visit ====================

    (0, 1,
     "PM మోదీ జనవరి 8, 2025న విశాఖపట్నంలో ప్రారంభించిన మొత్తం ప్రాజెక్టుల విలువ ఎంత?",
     "₹50,000 కోట్లు", "₹1 లక్ష కోటి", "₹2 లక్షల కోట్లుకు పైగా", "₹3 లక్షల కోట్లు",
     "c",
    ...
    (0, 1,
     ...
     "అమరావతి", "కాకినాడ", "పుడిమడక (విశాఖ)", "తిరుపతి",
     "c",
    ...
    (0, 2,
     ...
     "₹50,000 కోట్లు", "₹1,00,000 కోట్లు", "₹1,85,000 కోట్లు", "₹2,50,000 కోట్లు",
     "c",
    ...
    (1, 2,
     ...
     "జనవరి 1, 2025", "మే 2, 2025", "డిసెంబర్ 13, 2024", "నవంబర్ 1, 2024",
     "c",
    ...
    (1, 2,
     ...
     "₹100 లక్షల కోట్లు", "₹200 లక్షల కోట్లు", "₹308 లక్షల కోట్లు", "₹500 లక్షల కోట్లు",
     "c",
    ...
    # ==================== Section 2: AP Budget 2025-26 ====================

    (2, 1,
     "AP బడ్జెట్ 2025-26 ఎంత మొత్తానికి సమర్పించారు?",
     "₹2,52,000 కోట్లు", "₹2,88,125 కోట్లు", "₹3,22,359 కోట్లు", "₹3,85,000 కోట్లు",
     "c",
    ...
    (2, 1,
     ...
     "ఫిబ్రవరి 1, 2025", "ఫిబ్రవరి 20, 2025", "ఫిబ్రవరి 28, 2025", "మార్చి 1, 2025",
     "c",
    ...
    (4, 1,
     ...
     "₹2,000 కోట్లు", "₹3,500 కోట్లు", "₹5,936 కోట్లు", "₹8,000 కోట్లు",
     "c",
    ...
    (5, 2,
     ...
     "IBM India", "Google DeepMind", "Qubit Force", "IIT Hyderabad Quantum Lab",
     "c",
    ...
    (6, 1,
     ...
     "వెస్టర్న్ నావల్ కమాండ్ (ముంబయి)", "నార్తర్న్ నావల్ కమాండ్ (కర్వార్)", "ఈస్టర్న్ నావల్ కమాండ్ (విశాఖ)", "ఆండమాన్ నావల్ కమాండ్",
     "c",
     "INS అర్నాల విశాఖపట్నంలోని తూర్పు నావల్ కమాండ్ (Eastern Naval Command) లో ప్రవేశపెట్టారు."),

    (6, 2,
     "INS అర్నాల ఏ రకమైన యుద్ధనౌక?",
     "Aircraft Carrier", "Destroyer", "Shallow-Water ASW Corvette", "Submarine",
     "c",
    ...
    (6, 2,
     ...
     "50 మీ., 800 టన్నులు", "65 మీ., 1,200 టన్నులు", "77 మీ., 1,490 టన్నులు", "100 మీ., 3,000 టన్నులు",
     "c",
    ...
    (7, 1,
     ...
     "అమ్మ ఒడి పథకం", "జగనన్న అమ్మ వోడి", "ఉచిత బస్సు ప్రయాణం", "ఆరోగ్య శ్రీ పథకం",
     "c",
    ...
    (7, 2,
     ...
     "కృష్ణా జిల్లా, పమర్రు మండలం", "పశ్చిమ గోదావరి జిల్లా, పాలకొల్లు", "ప్రకాశం జిల్లా, దార్సి మండలం", "గుంటూరు జిల్లా, తాడేపల్లి",
     "c",
    ...
    # ==================== Section 8: Jul-Aug 2025 Other Events ====================
    ...
    (8, 1,
     ...
     "జులై 7, 2025", "జులై 19, 2025", "ఆగస్టు 7, 2025", "ఆగస్టు 15, 2025",
     "c",
