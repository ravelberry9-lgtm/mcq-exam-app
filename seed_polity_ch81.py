...
_MCQ_DATA = [    (0,
     'easy',
     'What is the main difference between RPA 1950 and RPA 1951?\nతెలుగు: RPA 1950 vs RPA 1951 main difference ఏమిటి?',
     'Same Act, different years',
     'RPA 1950: electoral rolls, delimitation, allocation of seats; RPA 1951: conduct of elections, candidate qualification/disqualification, corrupt practices, election petitions — two different Acts covering different aspects of elections',
     'Only names differ',
     'RPA 1950 is repealed',
     'b',
    ...
    (0,
     'medium',
     'Which Act do the Conduct of Elections Rules 1961 implement?\nతెలుగు: Conduct of Elections Rules 1961 ఏ Act ను implement చేస్తాయి?',
     'RPA 1950',
     'RPA 1951 — Conduct of Elections Rules 1961 contain detailed procedural rules for conducting elections; made by ECI under powers delegated in RPA 1951; cover: nomination, scrutiny, withdrawal, polling, counting, declaration processes',
    ...
    (0,
     'easy',
     'Which Act governs the Presidential election?\nతెలుగు: Presidential election ఏ Act govern చేస్తుంది?',
     'RPA 1951',
     'Presidential and Vice-Presidential Elections Act 1952 — specific Act governing the procedure for election of President and Vice-President; different from LS/State elections; covers: nomination (50 proposers + 50 seconders for President), election petition before SC',
     'Constitution alone',
    ...
    (0,
     'medium',
     'What is the Election Symbols (Reservation and Allotment) Order 1968?\nతెలుగు: Election Symbols Order 1968 ఏ Order?',
     'ECI circular',
     'ECI order under Art.324 — governs allotment of symbols to parties and candidates; specifies reserved symbols (for recognized parties) and free symbols (for others); ECI decides symbol disputes in party splits',
     'Parliamentary Act',
     'Presidential Order',
     'b',
    ...
    (0,
     'hard',
     'What does Art.327 enable Parliament to do?\nతెలుగు: Art.327 ఏ Parliament ని enable చేస్తుంది?',
     'Pass anti-defection law',
     'Make provisions with respect to elections to Parliament and State Legislatures — subject to Constitution, Parliament may by law make provision with respect to all matters relating to elections to Parliament/State Legislatures including preparation of electoral rolls, delimitation of constituencies, and all other related matters',
     'Set voting age',
     'Appoint ECI',
     'b',
    ...
    (0,
     'easy',
     'On what legal basis does the MCC operate?\nతెలుగు: Model Code of Conduct (MCC) ఏ law basis పై?',
     'Constitutional provision Art.324',
     "Non-statutory — not based on any Act of Parliament; based on consensus among political parties; ECI enforces it through powers under Art.324; evolved over time (first for Kerala 1960, national from 1971); SC has upheld ECI's power to enforce MCC without statutory backing",
     'RPA 1951 Sec.125',
     'Supreme Court order',
     'b',
    ...
    (0,
     'medium',
     'What role does the Government of NCT Delhi Act 1991 play in elections?\nతెలుగు: Government of NCT of Delhi Act 1991 ఏ role పోషిస్తుంది elections లో?',
     'Only administrative',
     'Governs elections to Delhi Legislative Assembly — Delhi has special UT with Legislature status; elections to Delhi Assembly governed by this Act + RPA 1951 as applicable; ECI conducts Delhi elections under Art.324',
     'Creates ECI for Delhi',
     'Delimits Delhi',
     'b',
    ...
    (0,
     'hard',
     "What is the State Legislature's power under Art.328?\nతెలుగు: Art.328 State Legislature elections self-legislation power ఏమిటి?",
     'States can override Parliament',
     "States can make law for their own Legislative Assembly elections — Art.328: subject to Art.327 and Constitution, State Legislature may by law make provision with respect to elections to their own House; BUT Parliament's law (Art.327) prevails in conflict; States cannot contradict RPA 1951",
     'States can abolish elections',
     'States control ECI',
     'b',
    ...
    (1,
     'easy',
     'What subjects does RPA 1950 cover?\nతెలుగు: RPA 1950 ఏ subjects cover చేస్తుంది?',
     'Corrupt practices',
     'Allocation of seats in Parliament/State Legislatures + delimitation of constituencies + preparation and revision of electoral rolls — RPA 1950 is the foundational law for electoral structure',
     'Election petitions',
    ...
    (1,
     'medium',
     'What is the role of an Electoral Registration Officer?\nతెలుగు: Electoral Registration Officer (ERO) ఏ role?',
     'Conducts elections',
     'Maintains electoral roll for the constituency — ERO is appointed by ECI; responsible for: preparing electoral roll, enrolling voters, updating roll annually, conducting special camps for enrollment, handling claims and objections, certifying final rolls',
     'Counts votes',
     'Allots symbols',
     'b',
    ...
    (1,
     'easy',
     'What is the qualifying date for electoral roll?\nతెలుగు: Electoral roll qualifying date ఏమిటి?',
     'January 26',
     "January 1 of each year — voters must be 18 years as of January 1 to qualify for that year's electoral roll; annual revision based on January 1 qualifying date",
     'March 31',
     'November 1',
     'b',
    ...
    (1,
     'medium',
     "Who are 'service voters' in election law?\nతెలుగు: Service voters ఏమిటి?",
     'Government employees',
     'Armed forces personnel, state police serving outside state, employees of Govt abroad — service voters can enroll at their home constituency or service constituency; can vote by postal ballot; special provision as they may not be at home during elections',
     'Railway employees',
     'ECI employees',
     'b',
    ...
    (1,
     'easy',
     'Since when are NRIs eligible to vote?\nతెలుగు: Overseas voters (NRIs) ఎప్పటి నుండి eligible?',
     '1991',
     '2010 — RPA (Amendment) Act 2010 gave Indian citizens residing abroad (with valid Indian passport) the right to register as voters in their home constituency in India',
     '2000',
     '1977',
     'b',
    ...
    (1,
     'medium',
     'What is the process of preparing electoral rolls?\nతెలుగు: Electoral roll preparation process ఏమిటి?',
     'ECI prepares directly',
     "ERO prepares draft roll → public notice → claims (inclusion applications) → objections (deletion applications) → hearings → disposal → final roll published — under ECI's superintendence; annual revision process",
     'Gram Sabha prepares',
     'Collector prepares independently',
     'b',
    ...
    (1,
     'hard',
     'On what grounds can a person be deleted from electoral roll?\nతెలుగు: Electoral roll deletion ఏ grounds పై?',
     'Any reason',
     '(1) Death of voter; (2) Permanent migration from constituency; (3) Not ordinary resident; (4) Disqualification (non-citizen, convicted, unsound mind); (5) Overseas — if registered as overseas voter in same constituency no issue; ERO acts on objection or suo motu after inquiry',
     "Voter's wish only",
     'Only for non-voters',
     'b',
    ...
    (1,
     'easy',
     'What information does the electoral roll contain?\nతెలుగు: Electoral roll nominal roll ఏ information contain చేస్తుంది?',
     'Only name and address',
     "Name, father's/husband's/mother's name, age, sex, address, EPIC number, photograph (in photo electoral roll) — electoral roll is a list of registered voters in a constituency with these details",
     'Only EPIC number',
     'Only address',
     'b',
    ...
    (2,
     'easy',
     'What does Section 8 of RPA 1951 provide?\nతెలుగు: Sec.8 RPA 1951 ఏమిటి?',
     'Party registration',
     'Disqualification for conviction — person convicted of specified offences (Sec.8(1)) or convicted and sentenced to 2+ years (Sec.8(3)) is disqualified for 6 years from date of release from prison',
     'Security deposit',
     'Nomination rules',
     'b',
    ...
    (2,
     'medium',
     'What is Section 29A of RPA 1951?\nతెలుగు: Sec.29A RPA 1951 ఏమిటి?',
     'Election petition',
     'Registration of political parties with ECI — Sec.29A: any association of citizens wishing to be registered as political party applies to ECI; must commit to democratic, socialist, secular principles; 30-day public notice; ECI registers after examination',
     'Corrupt practice',
     'Nomination process',
     'b',
    ...
    (2,
     'easy',
     'When is the security deposit forfeited under Sec.47?\nతెలుగు: Sec.47 RPA 1951 — security deposit forfeiture ఎప్పుడు?',
     'If candidate wins',
     'If candidate fails to secure more than 1/6 (one-sixth) of total valid votes polled in the constituency — candidate who gets 1/6 or more of votes retains deposit; less than 1/6 → deposit forfeited',
     'If petition filed',
     'Always forfeited',
     'b',
    ...
    (2,
     'medium',
     'What does Section 62 provide?\nతెలుగు: Sec.62 RPA 1951 ఏమిటి?',
     'Candidate qualification',
     'Right to vote — Sec.62: every person enrolled on electoral roll has right to vote; disqualified person cannot vote; person in lawful custody also cannot vote unless ECI arranges (for some categories)',
     'Party registration',
     'Election dispute',
     'b',
    ...
    (2,
     'hard',
     'What grounds under Sec.100 declare an election void?\nతెలుగు: Sec.100 RPA 1951 ఏ grounds అవుతాయి election void?',
     'Only corrupt practice',
     'Multiple: (1) Returned candidate not duly qualified; (2) Returned candidate was disqualified; (3) Corrupt practice by returned candidate or with his consent; (4) Improper reception/rejection of votes materially affecting result; (5) Non-compliance with Constitution or RPA provisions materially affecting result',
     'Only expenditure violation',
     'Only nomination error',
     'b',
    ...
    (2,
     'easy',
     'What does Section 126A of RPA 1951 provide?\nతెలుగు: Sec.126A RPA 1951 ఏమిటి?',
     'Nomination rules',
     'Exit poll ban — Sec.126A: no person shall conduct, publish, or publicise exit poll results during the period from voting commencement until last phase of voting ends; violation: imprisonment up to 2 years or fine or both',
     'Security deposit',
     'Booth capturing',
     'b',
    ...
    (2,
     'medium',
     'What does Section 151A say about by-elections?\nతెలుగు: Sec.151A RPA 1951 by-election ఏ time?',
     'By-election optional',
     'Within 6 months of vacancy — Sec.151A: ECI shall fill any vacancy in Parliament or State Legislature through a by-election conducted within 6 months from date of occurrence of vacancy; exception: remaining term less than 1 year',
     'Within 3 months',
     'Within 1 year',
     'b',
    ...
    (2,
     'hard',
     'What disqualifications do Sections 9 and 10 provide?\nతెలుగు: Sec.9 and Sec.10 RPA 1951 disqualifications ఏమిటి?',
     'Conviction only',
     'Sec.9: disqualification for dismissal from government service for corruption/disloyalty — dismissed government employee disqualified for 5 years; Sec.10: directorships in government companies — holding director/manager position in a government company = office of profit → disqualification',
    ...
    (3,
     'easy',
     'How many corrupt practices are listed in Section 123?\nతెలుగు: Sec.123 RPA 1951 లో corrupt practices ఎన్ని?',
     '5',
     '8 — Section 123 lists 8 types of corrupt practices; finding of corrupt practice against returned candidate → election void',
     '6',
     '10',
     'b',
    ...
    (3,
     'medium',
     'What constitutes bribery as a corrupt practice?\nతెలుగు: Bribery corrupt practice ఏమిటి?',
     'Only cash payments',
     'Giving, offering, agreeing to give any gratification to any person to induce that person to vote or not to vote or to vote in a particular way — includes: cash, gifts, free meals, free transport, free liquor (for votes)',
    ...
    (3,
     'easy',
     'What constitutes undue influence as a corrupt practice?\nతెలుగు: Undue influence corrupt practice ఏమిటి?',
     'Political persuasion',
     'Direct or indirect interference or attempt to interfere with free exercise of electoral right — threats: of divine displeasure, social ostracism, injury to person/property/employment; or promising benefits if person votes/abstains',
     'Press criticism',
     'Party campaigning',
     'b',
    ...
    (3,
     'medium',
     'What constitutes a religious/caste appeal as corrupt practice?\nతెలుగు: Religious/caste appeal corrupt practice ఏమిటి?',
     'Any campaign speech',
     "Appeal to voters to vote or not to vote on grounds of religion, race, caste, community, language — OR promotion of enmity or hatred between classes on these grounds in connection with election — candidate or agent's promotion of electoral prospects on grounds of religion/caste",
     'Any criticism',
     'Any cultural reference',
     'b',
    ...
    (3,
     'easy',
     'What is the corrupt practice of false statements?\nతెలుగు: False statements corrupt practice ఏమిటి?',
     'Campaign exaggerations',
     "Publishing false statement about candidate's personal character or conduct — Sec.123(4): publishing false statements likely to prejudice voting for a candidate; covers personal (not political) character; deliberately false publication",
     'Any negative ad',
     'Press reports',
     'b',
    ...
    (3,
     'medium',
     'What is the corrupt practice of hiring vehicles?\nతెలుగు: Vehicle hiring corrupt practice ఏమిటి?',
     'Arranging party conveyances',
     'Hiring/procuring vehicles/vessels for conveying electors to polling station — Sec.123(5): hiring or obtaining any vehicle or vessel for free conveyance of electors to/from polling station within 2km; this deprives voters of free choice by creating obligation',
     'Providing food',
     'Holding rally',
     'b',
    ...
    (3,
     'hard',
     'What is the punishment for booth capturing under Sec.135A?\nతెలుగు: Booth capturing Sec.135A ఏ punishment?',
     'Only fine',
     'Imprisonment up to 3 years (or fine or both) for first offence; imprisonment up to 5 years (or fine or both) for second or subsequent offence — Sec.135A: capturing a polling booth by seizing ballot boxes/machines, preventing voting, etc.',
     'Only 6 months',
     'Life imprisonment',
     'b',
    ...
    (3,
     'easy',
     'What does Section 126 of RPA 1951 prohibit?\nతెలుగు: Sec.126 RPA 1951 ఏమిటి?',
     'Election petition',
     'Public meetings within 48 hours before polling — Sec.126: no person shall convene, hold, attend, join or address any public meeting in a constituency within the 48-hour period ending with the hour fixed for conclusion of polling; violation: up to 2 years imprisonment',
     'Symbol use',
     'Party registration',
     'b',
    ...
    (4,
     'easy',
     'How much security deposit must a Lok Sabha candidate pay?\nతెలుగు: LS election security deposit ఎంత?',
     'Rs.10,000',
     'Rs.25,000 — general category candidate contesting LS or RS election must deposit Rs.25,000 with ECI; SC/ST candidates: Rs.12,500 (half)',
     'Rs.50,000',
     'Rs.5 lakh',
     'b',
    ...
    (4,
     'medium',
     'What is the threshold for deposit forfeiture?\nతెలుగు: Deposit forfeiture threshold ఏమిటి?',
     'Less than 1/10 votes',
     'Less than 1/6 of total valid votes polled in constituency — Sec.47 RPA 1951: deposit forfeited if candidate fails to get more than one-sixth of total valid votes; candidate must get more than 16.67% to retain deposit',
     'Less than 5% votes',
     'Less than 1/3 votes',
     'b',
    ...
    (4,
     'easy',
     'How much security deposit for a State Assembly election?\nతెలుగు: State Assembly election security deposit ఎంత?',
     'Rs.25,000',
     'Rs.12,500 — general category candidate for State Legislative Assembly or State Legislative Council election must deposit Rs.12,500; SC/ST candidates: Rs.6,250',
     'Rs.5,000',
     'Rs.1 lakh',
     'b',
    ...
    (4,
     'medium',
     'What is the purpose of the security deposit requirement?\nతెలుగు: Security deposit purpose ఏమిటి?',
     'Revenue collection',
     'Deters non-serious candidates from contesting — without deposit requirement, anyone could file nominations frivolously; deposit deters those who know they have no chance; forfeiture mechanism filters out candidates who get very few votes',
     'Only administrative',
    ...
    (4,
     'hard',
     'When is the security deposit returned to a candidate?\nతెలుగు: Security deposit ఏ time return చేయబడుతుంది?',
     'Always returned',
     'Returned if candidate gets more than 1/6 of valid votes — after election result, ECI/Returning Officer returns deposit to candidate or their authorized agent if threshold met; deposit is forfeited to Consolidated Fund of India if candidate gets 1/6 or less',
     'Only if candidate wins',
     'Only after 6 months',
     'b',
    ...
    (4,
     'easy',
     'How many proposers must sign a Lok Sabha nomination paper?\nతెలుగు: Nomination paper ని ఎన్ని proposers sign చేయాలి?',
     '10 proposers always',
     '1 proposer for recognized party candidates — for candidates of recognized (national or state) parties: 1 proposer from the constituency; for others (including registered unrecognized parties and independents): 10 proposers from the constituency',
     '5 proposers',
     '50 proposers',
     'b',
    ...
    (4,
     'medium',
     'How many proposers and seconders are needed for Presidential election nomination?\nతెలుగు: రాష్ట్రపతి ఎన్నిక nomination కి ఎంత మంది proposers అవసరం?',
     '10 proposers + 10 seconders',
     '50 proposers + 50 seconders from the Electoral College — Presidential and VP Elections Act 1952: nomination papers for Presidential candidate must be subscribed by at least 50 electors from the Electoral College as proposers and 50 as seconders',
     '25 proposers',
     '100 proposers',
     'b',
    ...
    (4,
     'hard',
     'What is the nomination requirement for Vice-Presidential election?\nతెలుగు: VP election nomination ఏ requirement?',
     '50 proposers + 50 seconders',
     '20 proposers + 20 seconders from members of Parliament (both Houses) — VP Electoral College: both elected AND nominated members of both Houses; different from Presidential Electoral College (which excludes nominated members and MLAs)',
     'Only elected MPs',
     '10 proposers + 10 seconders',
     'b',
    ...
    (5,
     'easy',
     'What is the time limit for filing an election petition?\nతెలుగు: Election petition ఏ time limit?',
     '30 days',
     "45 days from result declaration — must be filed within 45 days of the date on which the returning officer makes the declaration of the elected candidate's name (date of publication of result)",
     '90 days',
     '6 months',
     'b',
    ...
    (5,
     'medium',
     'Who can file an election petition?\nతెలుగు: Election petition ఎవరు file చేయవచ్చు?',
     'Only losing candidate',
     'Any candidate who contested + any elector of the constituency — RPA 1951 Sec.81: election petition may be presented by any candidate at the election or any elector (registered voter in that constituency)',
    ...
    (5,
     'easy',
     'What was Indira Gandhi v. Raj Narain (1975) about?\nతెలుగు: Indira Gandhi v. Raj Narain (1975) ఏమిటి?',
     'Emergency declaration',
     "Allahabad HC voided Indira Gandhi's LS election (Rae Bareli constituency, 1971) for corrupt practice — government officials (Yashpal Kapoor) used in election campaign; HC declared her election void; she was disqualified for 6 years",
    ...
    (5,
     'medium',
     'What role did the 39th Amendment 1975 play in Indira Gandhi case?\nతెలుగు: 39th Amendment 1975 ఏ role played?',
     'Created Electoral Court',
     "Retroactively validated Indira Gandhi's election — placed election of President, VP, PM, Speaker beyond judicial review; created special electoral mechanism; Minnerva Mills struck down parts later; 44th Amendment 1978 (post-Emergency) removed this protection",
     'Created ECI',
     'Changed voting age',
     'b',
    ...
    (5,
     'hard',
     'Where does an appeal lie from a HC judgment in an election petition?\nతెలుగు: HC election petition judgment పై appeal ఎక్కడ దాఖలు చేయాలి?',
     'To ECI',
     'Directly to Supreme Court — under Art.136 (Special Leave Petition) or Art.133/132; appeal from HC election judgment goes directly to SC; not to any intermediate appellate court; SC can entertain SLP against HC election judgment',
     'To a Divisional Bench',
     'To President',
     'b',
    ...
    (5,
     'easy',
     'What relief can be granted when an election is declared void?\nతెలుగు: Election declared void ఆ తర్వాత ఏ relief?',
     'Only re-election',
     'Three reliefs: (1) Simply declare election void (re-election ordered by ECI); OR (2) Declare petitioner as elected candidate; OR (3) Declare election void + order fresh election — decision of HC (or SC for President/VP)',
     'Only petitioner elected',
     'No relief possible',
     'b',
    ...
    (5,
     'medium',
     'Before which court is an election petition tried?\nతెలుగు: Election petition trial ఏ court లో?',
     'District Court',
     'High Court of the State — LS and State Assembly election petitions are tried by HC; originally had election tribunals, then in 1966 Parliament transferred jurisdiction to HCs; Presidential election petition and VP election petition → before SC',
    ...
    (5,
     'hard',
     "What is 'recrimination' in election petition?\nతెలుగు: Election petition ప్రక్రియలో 'recrimination' అంటే ఏమిటి?",
     'Filing counter petition',
     'When election petition seeks to have petitioner declared elected instead of void only — returned candidate can recriminate: show petitioner is also guilty of corrupt practice; if petitioner proved guilty, HC cannot declare them elected; both parties can be disqualified if both guilty of corrupt practice',
     'Only appeals',
     'ECI review',
     'b',
    ...
    (6,
     'easy',
     'What is the PR-STV method?\nతెలుగు: PR-STV method ఏమిటి?',
     'Party-based proportional',
     'Proportional Representation by Single Transferable Vote — voters rank candidates 1, 2, 3 in order of preference; Droop Quota = (Total votes',
     'First Past the Post',
     'Block voting',
     'b',
    ...
    (6,
     'medium',
     'How is the Droop Quota calculated?\nతెలుగు: Droop Quota calculation ఏమిటి?',
     '50% + 1 votes',
     '(Total valid votes',
     'Total votes',
     'Total votes',
    ...
    (6,
     'easy',
     'What method is used for Rajya Sabha elections?\nతెలుగు: Rajya Sabha elections ఏ method use చేస్తాయి?',
     'First Past the Post',
     'Single Transferable Vote (STV) — elected MLAs of State Assembly vote for RS candidates by ranking them in order of preference; STV with Droop Quota method determines winners',
     'Direct election',
     'PR-List system',
     'b',
    ...
    (6,
     'medium',
     'How is voter weightage calculated in the Presidential election?\nతెలుగు: Presidential election voter weightage ఏమిటి?',
     'All votes equal',
     'State MLA value: 1 MLA vote = (State population',
     'Only MPs decide',
     '50% population rule',
     'b',
    ...
    (6,
     'easy',
     'What is the Electoral College for VP election?\nతెలుగు: Vice-President election Electoral College ఏమిటి?',
     'Only elected MPs',
     'All members of Parliament (both elected AND nominated) in a joint sitting — Art.66: VP elected by all members of Parliament (LS + RS) both elected and nominated; unlike Presidential election which includes MLAs but excludes nominated MPs',
     'Only MLAs',
     'Only Lok Sabha',
     'b',
    ...
    (6,
     'medium',
     'How much is the security deposit for Presidential election?\nతెలుగు: Presidential election security deposit ఎంత?',
     'Rs.1 lakh',
     "Rs.15,000 — security deposit for Presidential election nomination under Presidential and VP Elections Act 1952; forfeited if candidate doesn't get 1/6 of first preference votes",
     'Rs.25,000',
     'Rs.5 lakh',
     'b',
    ...
    (6,
     'hard',
     'Which census population is used for Presidential election vote values?\nతెలుగు: Presidential election ఏ census population use చేస్తుంది?',
     'Latest census',
     "1971 census — MLA vote values frozen at 1971 census figures; this was done by 84th Amendment 2001 (as part of seat freeze until 2026); ensures states that controlled population growth don't lose vote value in Presidential elections",
     '2001 census',
     '2011 census',
     'b',
    ...
    (6,
     'easy',
     'Before which court is a Presidential election petition filed?\nతెలుగు: Presidential election petition ఏ court?',
     'High Court',
     "Supreme Court — Art.71 and Presidential and VP Elections Act 1952: disputes relating to election of President or VP shall be decided by Supreme Court; SC's decision is final",
     'Parliament',
     'ECI',
     'b',
    ...
    (7,
     'easy',
     'How many corrupt practices are listed under Sec.123?\nతెలుగు: Sec.123 corrupt practices ఎన్ని?',
     '5',
     '8 — bribery; undue influence; religious/caste appeal; use of religious/national symbols; false statements; hiring vehicles; excess expenditure; obtaining Govt servant assistance (+ booth capturing)',
     '6',
     '10',
     'b',
    ...
    (7,
     'medium',
     'Which court decided the Indira Gandhi election case (1975)?\nతెలుగు: Indira Gandhi election case ఏ court decided?',
     'Supreme Court',
     "Allahabad High Court — Justice Jagmohan Lal Sinha; June 12, 1975; voided Indira Gandhi's 1971 LS election from Rae Bareli; ground: use of government servant (Yashpal Kapoor) in election — corrupt practice Sec.123(7)",
     'Election Tribunal',
     'ECI',
     'b',
    ...
    (7,
     'easy',
     'What is the security deposit forfeiture threshold?\nతెలుగు: Security deposit forfeiture threshold ఏమిటి?',
     'Less than 5%',
     'Less than 1/6 of valid votes — Sec.47 RPA 1951: deposit forfeited if candidate fails to get more than one-sixth of total valid votes polled',
     'Less than 10%',
     'Less than 25%',
     'b',
    ...
    (7,
     'medium',
     'In which Indian elections is PR-STV used?\nతెలుగు: PR-STV ఏ elections లో use అవుతుంది?',
     'Only Lok Sabha',
     'Presidential election + VP election + Rajya Sabha elections + State Legislative Council elections — PR-STV used in all indirect elections in India; FPTP used for all direct elections (LS, State Assembly)',
     'Only State Assembly',
     'Only VP election',
     'b',
    ...
    (7,
     'easy',
     'Which section of RPA governs booth capturing?\nతెలుగు: Booth capturing ఏ section govern చేస్తుంది?',
     'Sec.123',
     'Sec.135A RPA 1951 — booth capturing is a separate election offence (not just a corrupt practice); imprisonment up to 3 years (first offence) or 5 years (second offence)',
     'Sec.100',
     'Sec.126',
     'b',
    ...
    (7,
     'medium',
     'During what period are exit polls banned?\nతెలుగు: Exit poll ban ఏ time period?',
     'Only on polling day',
     'From start of voting in first phase to end of voting in last phase — Sec.126A RPA 1951: entire voting period (including all phases in multi-phase election) is covered by exit poll ban; ban lifted only after last vote cast',
     '1 day before polling',
    ...
    (7,
     'hard',
     'What did 39th Amendment 1975 add?\nతెలుగు: 39th Amendment 1975 ఏ provision add చేసింది?',
     'Emergency provisions',
     "Placed election of President, VP, PM, Speaker beyond judicial review + retroactively validated Indira Gandhi's election — subsequently reversed by 44th Amendment 1978 (post-Emergency); added Art.329A (since deleted); SC found it unconstitutional in Indira Gandhi vs Union of India reference",
     'Anti-defection law',
     'VP election change',
     'b',
    ...
    (7,
     'easy',
     'What is the last date for withdrawal of candidature?\nతెలుగు: Nomination withdrawal last date ఏమిటి?',
     'On polling day',
     '2 days after scrutiny of nominations — election schedule: nomination → scrutiny (next day after last nomination day) → withdrawal last date (2 days after scrutiny) → polling; candidate can withdraw within this period',
     '7 days before polling',
     'After nomination only',
     'b',
